...
Approval reference: #5574 + Todd 2026-07-18 standing retry grant (Flip attempt 4 for #4053)
...
This approval is limited to the reviewed App Platform live-domain detach set for the
production DOKS serving flip. Any different fingerprint or destructive resource address
must fail closed.
