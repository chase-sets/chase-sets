...
// Keep event reads bounded to match list and poison-event page hardening. The
// value is declared once in the storage contract so the canonical
// complete-history reader pages at exactly what this store enforces.
export const EVENT_STORE_READ_PAGE_SIZE_DEFAULT = EVENT_STORE_READ_PAGE_SIZE_MAX;
export const EVENT_STORE_READ_PAGE_SIZE_LIMIT = EVENT_STORE_READ_PAGE_SIZE_MAX;
