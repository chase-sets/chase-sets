...
It does not own managed Postgres, context databases, PgBouncer pools, DNS, Spaces asset buckets, observability storage, Kubernetes workloads, ingress, secrets, Helm charts, or runtime manifests. Those remain in their dedicated roots.
