...
import { inventoryCallerSelectableAdjustmentReasons } from "@chase-sets/event-core/public-event-payloads/inventory";
        ...
        objectSchema(
          {
            ...
            reasonCode: stringProperty("Typed reason for the stock adjustment.", [
