        ...
        objectSchema(
          {
            ...
            selectedListingSnapshot: {
              ...
              properties: {
                ...
                priceCurrencyCode: stringProperty("Listing price ISO 4217 currency code."),
                listingStreamVersion: integerProperty("Listing stream version that authored the price pair."),
