      ...
      <SelectPrimitive.Trigger
        ...
        className={(state) =>
          cn(
            ...
            state.open &&
              "border-[var(--ring)] bg-[var(--secondary)] shadow-[0_0_0_3px_color-mix(in_srgb,var(--ring)_18%,transparent),var(--shadow-md)]",
          )
        }
      >
        ...
        <SelectPrimitive.Icon>
          <ChevronDown
            className="h-4 w-4 opacity-70 transition-transform duration-200 data-[popup-open]:rotate-180"
            aria-hidden="true"
          />
        </SelectPrimitive.Icon>
      </SelectPrimitive.Trigger>
                ...
                <SelectPrimitive.Item
                  ...
                  className={(state) =>
                    cn(
                      ...
                      state.highlighted &&
                        !state.selected &&
                        "bg-[color-mix(in_srgb,var(--primary)_14%,var(--secondary))] text-[var(--foreground)]",
                ...
                >
                  ...
                  <SelectPrimitive.ItemText>
                    <span className="grid min-w-0 gap-0.5">
                      ...
                      {item.description ? (
                        <span className="text-xs leading-5 text-[var(--muted-foreground)]">{item.description}</span>
                      ) : null}
                    </span>
                  </SelectPrimitive.ItemText>
                </SelectPrimitive.Item>
