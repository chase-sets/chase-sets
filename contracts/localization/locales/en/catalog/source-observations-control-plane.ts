export const catalogSourceObservationsControlPlaneEnglishTranslations = {
  ...
  "catalog.features.sourceObservations.ui.cleanResetRelease.banner.blocked.description":
    "{count} reset, release, or removal blocker(s) must be cleared before signoff.",
  "catalog.features.sourceObservations.ui.cleanResetRelease.banner.blocked.title": "Clean reset release is blocked",
  "catalog.features.sourceObservations.ui.cleanResetRelease.banner.complete.description":
    "Clean reset/drop evidence, backfill state, smoke proof, and complete-removal evidence are ready for signoff.",
  "catalog.features.sourceObservations.ui.cleanResetRelease.banner.complete.title":
    "Clean reset release evidence is complete",
  "catalog.features.sourceObservations.ui.cleanResetRelease.banner.partial.description":
    "The release flow is defined, but reset/drop execution evidence has not completed yet.",
  "catalog.features.sourceObservations.ui.cleanResetRelease.banner.partial.title":
    "Clean reset release is pending evidence",
  "catalog.features.sourceObservations.ui.cleanResetRelease.blocksRelease": "blocks release",
  "catalog.features.sourceObservations.ui.cleanResetRelease.decisions.description":
    "Each release decision names the owner issue, evidence, required proof, and whether it blocks signoff.",
  "catalog.features.sourceObservations.ui.cleanResetRelease.decisions.title": "Release decision checklist",
  "catalog.features.sourceObservations.ui.cleanResetRelease.description":
    "Verify clean reset/drop/backfill release work, deploy-skew cleanup, temporary scaffolding deletion, and complete old-surface removal before signoff.",
  "catalog.features.sourceObservations.ui.cleanResetRelease.findings.description":
    "Reset evidence findings come from the Catalog data reset evidence evaluator and always block release until resolved.",
  "catalog.features.sourceObservations.ui.cleanResetRelease.findings.emptyDescription":
    "Reset/drop evidence satisfies the environment-specific requirements and clean postconditions.",
  "catalog.features.sourceObservations.ui.cleanResetRelease.findings.emptyTitle": "No reset evidence findings",
  "catalog.features.sourceObservations.ui.cleanResetRelease.findings.title": "Reset evidence findings",
  "catalog.features.sourceObservations.ui.cleanResetRelease.key.approval": "Approval required",
  "catalog.features.sourceObservations.ui.cleanResetRelease.key.backup": "Backup decision required",
  "catalog.features.sourceObservations.ui.cleanResetRelease.key.boundary": "Unrelated data boundary",
  "catalog.features.sourceObservations.ui.cleanResetRelease.key.environment": "Environment",
  "catalog.features.sourceObservations.ui.cleanResetRelease.key.mode": "Reset mode",
  "catalog.features.sourceObservations.ui.cleanResetRelease.links.description":
    "Proof links stay redaction-safe and point back to rebuilt workbench sections.",
  "catalog.features.sourceObservations.ui.cleanResetRelease.links.title": "Release proof links",
  "catalog.features.sourceObservations.ui.cleanResetRelease.metric.blocking": "blocking",
  "catalog.features.sourceObservations.ui.cleanResetRelease.metric.decisions": "Decisions",
  "catalog.features.sourceObservations.ui.cleanResetRelease.metric.findings": "Findings",
  "catalog.features.sourceObservations.ui.cleanResetRelease.metric.mustRemove": "must remove",
  "catalog.features.sourceObservations.ui.cleanResetRelease.metric.scaffolding": "Scaffolding",
  "catalog.features.sourceObservations.ui.cleanResetRelease.metric.tables": "Target tables",
  "catalog.features.sourceObservations.ui.cleanResetRelease.nonBlocking": "non-blocking",
  "catalog.features.sourceObservations.ui.cleanResetRelease.openAuditEvidence": "Open audit evidence",
  "catalog.features.sourceObservations.ui.cleanResetRelease.openEvidence": "Open evidence",
  "catalog.features.sourceObservations.ui.cleanResetRelease.readModel.decision.backfill.blocked":
    "Retained data still requires clean launch backfill or reset evidence.",
  "catalog.features.sourceObservations.ui.cleanResetRelease.readModel.decision.backfill.label":
    "Backfill produces clean launch state",
  "catalog.features.sourceObservations.ui.cleanResetRelease.readModel.decision.backfill.ready":
    "Backfill is skipped after clean wipe or complete for retained data.",
  "catalog.features.sourceObservations.ui.cleanResetRelease.readModel.decision.backup.label":
    "Backup or accepted data-loss decision",
  "catalog.features.sourceObservations.ui.cleanResetRelease.readModel.decision.backup.missing":
    "Backup/export decision or accepted data-loss approval is missing.",
  "catalog.features.sourceObservations.ui.cleanResetRelease.readModel.decision.backup.none":
    "No backup decision recorded.",
  "catalog.features.sourceObservations.ui.cleanResetRelease.readModel.decision.release.label":
    "Release acceptance and smoke proof",
  "catalog.features.sourceObservations.ui.cleanResetRelease.readModel.decision.removal.label":
    "Complete old-surface removal",
  "catalog.features.sourceObservations.ui.cleanResetRelease.readModel.decision.reset.evidenceMissing":
    "Reset/drop evidence packet is missing.",
  "catalog.features.sourceObservations.ui.cleanResetRelease.readModel.decision.reset.evidenceReady":
    "Reset/drop evidence packet is present.",
  "catalog.features.sourceObservations.ui.cleanResetRelease.readModel.decision.reset.label":
    "Destructive prelaunch reset/drop policy",
  "catalog.features.sourceObservations.ui.cleanResetRelease.readModel.decision.scaffolding.blocked":
    "Temporary reset, backfill, or deploy-skew scaffolding still requires deletion evidence.",
  "catalog.features.sourceObservations.ui.cleanResetRelease.readModel.decision.scaffolding.label":
    "Deploy-skew and temporary scaffolding removal",
  "catalog.features.sourceObservations.ui.cleanResetRelease.readModel.decision.scaffolding.ready":
    "No temporary scaffolding remains as a launch surface.",
  "catalog.features.sourceObservations.ui.cleanResetRelease.readModel.link.audit": "Audit evidence",
  "catalog.features.sourceObservations.ui.cleanResetRelease.readModel.link.policy": "Clean reset policy",
  "catalog.features.sourceObservations.ui.cleanResetRelease.readModel.scaffolding.backfill":
    "Backfill verification scaffold",
  "catalog.features.sourceObservations.ui.cleanResetRelease.readModel.scaffolding.deploySkew":
    "Deploy-skew release scaffold",
  "catalog.features.sourceObservations.ui.cleanResetRelease.readModel.scaffolding.notUsed":
    "Not used; no deletion evidence is required beyond this release record.",
  "catalog.features.sourceObservations.ui.cleanResetRelease.readModel.scaffolding.oldSurface":
    "Old-surface removal scaffold",
  "catalog.features.sourceObservations.ui.cleanResetRelease.readModel.scaffolding.removed":
    "Removed; evidence confirms this cannot remain as an internal support surface.",
  "catalog.features.sourceObservations.ui.cleanResetRelease.readModel.scaffolding.required":
    "Removal required before launch; temporary support surfaces cannot be retained.",
  "catalog.features.sourceObservations.ui.cleanResetRelease.readModel.scaffolding.reset": "Reset execution scaffold",
  "catalog.features.sourceObservations.ui.cleanResetRelease.scaffolding.description":
    "Temporary reset, backfill, deploy-skew, or cleanup scaffolding must be removed before launch or marked not used.",
  "catalog.features.sourceObservations.ui.cleanResetRelease.scaffolding.title": "Temporary scaffolding removal",
  "catalog.features.sourceObservations.ui.cleanResetRelease.table.backfill": "Backfill",
  "catalog.features.sourceObservations.ui.cleanResetRelease.table.decision": "Decision",
  "catalog.features.sourceObservations.ui.cleanResetRelease.table.evidence": "Evidence",
  "catalog.features.sourceObservations.ui.cleanResetRelease.table.finding": "Finding",
  "catalog.features.sourceObservations.ui.cleanResetRelease.table.kind": "Kind",
  "catalog.features.sourceObservations.ui.cleanResetRelease.table.owner": "Owner",
  "catalog.features.sourceObservations.ui.cleanResetRelease.table.proof": "Proof",
  "catalog.features.sourceObservations.ui.cleanResetRelease.table.redaction": "Redaction",
  "catalog.features.sourceObservations.ui.cleanResetRelease.table.release": "Release",
  "catalog.features.sourceObservations.ui.cleanResetRelease.table.removal": "Removal",
  "catalog.features.sourceObservations.ui.cleanResetRelease.table.scaffolding": "Scaffolding",
  "catalog.features.sourceObservations.ui.cleanResetRelease.table.severity": "Severity",
  "catalog.features.sourceObservations.ui.cleanResetRelease.table.status": "Status",
  "catalog.features.sourceObservations.ui.cleanResetRelease.title": "Clean reset release",
} as const;
