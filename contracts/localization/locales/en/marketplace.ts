export const marketplaceEnglishTranslations = {
  ...
  "marketplace.features.sellerDesk.meta.description":
    "Your seller landing surface: the attention queue and KPIs, with one-click paths into whatever needs work.",
  "marketplace.features.sellerDesk.kpis.title": "At a glance",
  "marketplace.features.sellerDesk.kpis.activeListings": "Active listings",
  "marketplace.features.sellerDesk.kpis.openOrdersToShip": "Open orders to ship",
  "marketplace.features.sellerDesk.kpis.nextPayout": "Next payout",
  "marketplace.features.sellerDesk.kpis.walletBalance": "Wallet balance",
  "marketplace.features.sellerDesk.kpis.unavailable": "Unavailable",
  "marketplace.features.sellerDesk.queue.title": "Needs you",
  "marketplace.features.sellerDesk.queue.description": "Ordered by urgency, deadline, and how long each has waited.",
  "marketplace.features.sellerDesk.queue.count": "{count} to handle",
  "marketplace.features.sellerDesk.degraded.title": "Some signals are temporarily unavailable",
  "marketplace.features.sellerDesk.degraded.description":
    "The rest of your queue is up to date. These signals return on their own.",
  "marketplace.features.sellerDesk.degraded.source": "{source}: {reason}",
  "marketplace.features.sellerDesk.degraded.reasonUnknown": "temporarily unavailable",
  "marketplace.features.sellerDesk.degraded.offerReadFailed": "Offers could not be loaded",
  "marketplace.features.sellerDesk.degraded.listingReadFailed": "Listings could not be loaded",
  "marketplace.features.sellerDesk.empty.title": "Nothing needs you",
  "marketplace.features.sellerDesk.empty.description":
    "Your queue is clear. When an order, offer, payout, or import needs attention, it appears here.",
  "marketplace.features.sellerDesk.empty.createListing": "Create a listing",
  "marketplace.features.sellerDesk.empty.viewInventory": "View inventory",
  ...
  "marketplace.features.sellerDesk.severity.critical": "Critical",
  "marketplace.features.sellerDesk.severity.warning": "Warning",
  "marketplace.features.sellerDesk.severity.info": "Info",
  "marketplace.features.sellerDesk.summary.shipByOverdue": "Shipment {reference} is past its ship-by deadline",
  "marketplace.features.sellerDesk.summary.shipBySoon": "Shipment {reference} is due to ship soon",
  "marketplace.features.sellerDesk.summary.shipByUpcoming": "Shipment {reference} has an upcoming ship-by deadline",
  "marketplace.features.sellerDesk.summary.payoutBlocked": "Payout {reference} is blocked: {reason}",
  ...
  "marketplace.features.sellerDesk.action.resolutionLink": "Resolve import",
