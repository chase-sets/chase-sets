export const fulfillmentEnglishTranslations = {
  ...
  "fulfillment.features.shipments.ui.shipmentPackingPage.locked.description":
    "Started {timestamp}. Buyer order changes and cancellation are locked while this package is being prepared.",
  "fulfillment.features.shipments.ui.shipmentPackingPage.locked.title": "Order changes locked while packing",
  "fulfillment.features.shipments.ui.shipmentPackingPage.order.line.reference": "Order line {reference}",
  ...
  "fulfillment.features.shipments.ui.shipmentPackingPage.product.reference": "Product {reference}",
  "fulfillment.features.shipments.ui.shipmentPackingPage.progress": "{checked} of {total} lines checked",
