export const reputationEnglishTranslations = {
  ...
  "reputation.features.reviews.api.route.authentication.context.missing.4": "Authentication context missing.",
  ...
  "reputation.features.reviews.ui.reviewDetailPage.reply.description":
    "Respond publicly to this review. You can reply once, and your response appears wherever the review is shown.",
  "reputation.features.reviews.ui.reviewDetailPage.reply.feedback": "Your response",
  "reputation.features.reviews.ui.reviewDetailPage.reply.feedback.description":
    "Up to 1000 characters. One response per review.",
  ...
  "reputation.routes.marketplace.accountReview.reply.failed": "Response could not be posted.",
