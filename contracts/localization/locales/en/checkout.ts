export const checkoutEnglishTranslations = {
  ...
  "checkout.features.sellList.ui.sellListPage.listing.price.currency.code.placeholder": "ISO 4217",
  ...
  "checkout.features.sellList.ui.sellListPage.offer.count.one": "{count} offer",
  ...
  "checkout.features.sellList.ui.sellListPage.item.offers.and.terms": "{item} offers and terms",
  "checkout.features.sellList.ui.sellListPage.drawer.description":
    "Compare every current offer and seller term without leaving the Sell List.",
  "checkout.features.sellList.ui.sellListPage.select.offer": "Select {buyer} offer",
  "checkout.features.sellList.ui.sellListPage.offer.quantity": "Quantity {quantity}",
  "checkout.features.sellList.ui.sellListPage.offer.selected": "{count} offer selected",
  "checkout.features.sellList.ui.sellListPage.offers.selected": "{count} offers selected",
  "checkout.features.sellList.ui.sellListPage.accept.selected": "Accept selected",
  "checkout.features.sellList.ui.sellListPage.decline.selected": "Decline selected",
  "checkout.features.sellList.ui.sellListPage.clear.selection": "Clear selection",
  ...
  "checkout.features.sellList.ui.sellListPage.evidence.needs.action": "Evidence needs action",
  "checkout.features.sellList.ui.sellListPage.evidence.required": "Required listing evidence",
  "checkout.features.sellList.ui.sellListPage.evidence.complete": "Required evidence is complete",
  "checkout.features.sellList.ui.sellListPage.evidence.listing": "Listing",
  "checkout.features.sellList.ui.sellListPage.evidence.classify": "Classify evidence",
  "checkout.features.sellList.ui.sellListPage.evidence.classify.action": "Save classification",
  "checkout.features.sellList.ui.sellListPage.evidence.add": "Add evidence",
  "checkout.features.sellList.ui.sellListPage.evidence.add.action": "Add photo",
  "checkout.features.sellList.ui.sellListPage.evidence.choose.slot": "Choose required view",
  "checkout.features.sellList.ui.sellListPage.evidence.photo": "Evidence photo",
  "checkout.features.sellList.ui.sellListPage.evidence.photo.description":
    "Use a distinct photo for each required view.",
  "checkout.features.sellList.ui.sellListPage.evidence.view.front": "Front",
  "checkout.features.sellList.ui.sellListPage.evidence.view.back": "Back",
  "checkout.features.sellList.ui.sellListPage.evidence.view.slab": "Slab",
  "checkout.features.sellList.ui.sellListPage.evidence.view.condition": "Condition",
  "checkout.features.sellList.ui.sellListPage.evidence.unavailable":
    "Listing evidence could not be loaded. Refresh before accepting this offer.",
