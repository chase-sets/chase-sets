export const pricingEnglishTranslations = {
  ...
  "pricing.features.publicMarketPages.routes.marketPriceHistory.meta.description":
    "See {item} price history, recent sales, and active listings on Chase Sets.",
  ...
  "pricing.features.publicMarketPages.ui.marketPriceHistoryPage.create.a.price.alert": "Create a price alert",
  "pricing.features.publicMarketPages.ui.marketPriceHistoryPage.sell.yours": "Sell yours",
