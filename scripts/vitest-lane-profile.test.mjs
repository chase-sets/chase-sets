...
test("keeps the exact 63+1 tracked Vitest config topology on the shared lane resolver", () => {
  ...
  assert.equal(trackedConfigs.length, 64);
  assert.equal(workspaceConfigs.length, 63);
  assert.deepEqual(
