...
describe("repository-wide SQL execution partition", () => {
  ...
  it("measures the exact five-module and enforcement-neutral partition transition", () => {
    ...
    expect(legacyModules).toHaveLength(2311);
    expect(governedModules).toHaveLength(2306);
    ...
    expect(legacyPartition.notSql).toHaveLength(1927);
    ...
    expect(partition.notSql).toHaveLength(1922);
