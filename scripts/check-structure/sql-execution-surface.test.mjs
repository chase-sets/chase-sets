...
describe("repository-wide SQL execution partition", () => {
  ...
  it("measures the exact five-module and enforcement-neutral partition transition", () => {
    ...
    expect(legacyModules).toHaveLength(2430);
    expect(governedModules).toHaveLength(2425);
    ...
    expect(legacyPartition.notSql).toHaveLength(2017);
    ...
    expect(partition.notSql).toHaveLength(2012);
