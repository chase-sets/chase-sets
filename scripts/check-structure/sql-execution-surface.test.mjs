...
describe("repository-wide SQL execution partition", () => {
  ...
  it("measures the exact five-module and enforcement-neutral partition transition", () => {
    ...
    expect(legacyModules).toHaveLength(2385);
    expect(governedModules).toHaveLength(2380);
    ...
    expect(legacyPartition.notSql).toHaveLength(1981);
    ...
    expect(partition.notSql).toHaveLength(1976);
