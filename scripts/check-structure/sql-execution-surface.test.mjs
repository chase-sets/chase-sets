...
describe("repository-wide SQL execution partition", () => {
  ...
  it("measures the exact five-module and enforcement-neutral partition transition", () => {
    ...
    expect(legacyModules).toHaveLength(2513);
    expect(governedModules).toHaveLength(2508);
    ...
    expect(legacyPartition.notSql).toHaveLength(2072);
    ...
    expect(partition.notSql).toHaveLength(2067);
