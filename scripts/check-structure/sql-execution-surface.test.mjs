...
describe("repository-wide SQL execution partition", () => {
  ...
  it("measures the exact five-module and enforcement-neutral partition transition", () => {
    ...
    expect(legacyModules).toHaveLength(2498);
    expect(governedModules).toHaveLength(2493);
    ...
    expect(legacyPartition.notSql).toHaveLength(2062);
    ...
    expect(partition.notSql).toHaveLength(2057);
