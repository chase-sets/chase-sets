...
describe("repository-wide SQL execution partition", () => {
  ...
  it("measures the exact five-module and enforcement-neutral partition transition", () => {
    ...
    expect(legacyModules).toHaveLength(2426);
    expect(governedModules).toHaveLength(2421);
    ...
    expect(legacyPartition.sqlExecuting).toHaveLength(414);
    expect(legacyPartition.unprovableForm).toHaveLength(3);
    expect(legacyPartition.notSql).toHaveLength(2009);
    ...
    expect(partition.notSql).toHaveLength(2004);
