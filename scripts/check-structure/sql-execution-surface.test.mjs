...
describe("SQL execution fixture matrix through the real guard entrypoint", () => {
  it("classifies P1-P10 and P12-P18 as SQL-executing at their named anchors", () => {
    const anchors = [
      ...
      ["bounded-contexts/identity/support/runtime-support/admin-qa-actor-fixtures.ts", 303, "db"],
  ...
  it("proves every already contract-annotated receiver, including P18", () => {
    const cases = [
      ...
      ["bounded-contexts/identity/support/runtime-support/admin-qa-actor-fixtures.ts", 303],
      [fixtureFile, 29],
      [fixtureFile, 37],
    ];
