...
describe("repository-wide SQL execution partition", () => {
  ...
  it("measures the exact five-module and enforcement-neutral partition transition", () => {
    ...
    expect(legacyModules).toHaveLength(2271);
    expect(governedModules).toHaveLength(2266);
    ...
    expect(legacyPartition.notSql).toHaveLength(1892);
    ...
    expect(partition.notSql).toHaveLength(1887);
