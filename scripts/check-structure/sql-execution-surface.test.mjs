...
describe("repository-wide SQL execution partition", () => {
  ...
  it("measures the exact five-module and enforcement-neutral partition transition", () => {
    ...
    expect(legacyModules).toHaveLength(2345);
    expect(governedModules).toHaveLength(2340);
    ...
    expect(legacyPartition.notSql).toHaveLength(1949);
    ...
    expect(partition.notSql).toHaveLength(1944);
