...
describe("repository-wide SQL execution partition", () => {
  ...
  it("measures the exact five-module and enforcement-neutral partition transition", () => {
    ...
    expect(legacyModules).toHaveLength(2483);
    expect(governedModules).toHaveLength(2478);
    ...
    expect(legacyPartition.notSql).toHaveLength(2053);
    ...
    expect(partition.notSql).toHaveLength(2048);
