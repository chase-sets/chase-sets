...
describe("repository-wide SQL execution partition", () => {
  ...
  it("measures the exact five-module and enforcement-neutral partition transition", () => {
    ...
    expect(legacyModules).toHaveLength(2465);
    expect(governedModules).toHaveLength(2460);
    ...
    expect(legacyPartition.notSql).toHaveLength(2036);
    ...
    expect(partition.notSql).toHaveLength(2031);
