...
describe("repository-wide SQL execution partition", () => {
  ...
  it("measures the exact five-module and enforcement-neutral partition transition", () => {
    ...
    expect(legacyModules).toHaveLength(2461);
    expect(governedModules).toHaveLength(2456);
    ...
    expect(legacyPartition.notSql).toHaveLength(2033);
    ...
    expect(partition.notSql).toHaveLength(2028);
