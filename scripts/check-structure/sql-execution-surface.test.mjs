...
describe("repository-wide SQL execution partition", () => {
  ...
  it("measures the exact five-module and enforcement-neutral partition transition", () => {
    ...
    expect(legacyModules).toHaveLength(2431);
    expect(governedModules).toHaveLength(2426);
    ...
    expect(legacyPartition.notSql).toHaveLength(2014);
    expect(legacyPartition.unresolvedMemberRoots.count).toBe(270);
    ...
    expect(partition.notSql).toHaveLength(2009);
