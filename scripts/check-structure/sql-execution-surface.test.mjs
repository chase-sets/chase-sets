...
describe("repository-wide SQL execution partition", () => {
  ...
  it("measures the exact five-module and enforcement-neutral partition transition", () => {
    ...
    expect(legacyModules).toHaveLength(2383);
    expect(governedModules).toHaveLength(2378);
    ...
    expect(legacyPartition.sqlExecuting).toHaveLength(400);
    expect(legacyPartition.unprovableForm).toHaveLength(3);
    expect(legacyPartition.notSql).toHaveLength(1980);
    ...
    expect(partition.notSql).toHaveLength(1975);
