...
describe("repository-wide SQL execution partition", () => {
  ...
  it("measures the exact five-module and enforcement-neutral partition transition", () => {
    ...
    expect(legacyModules).toHaveLength(2477);
    expect(governedModules).toHaveLength(2472);
    ...
    expect(legacyPartition.notSql).toHaveLength(2044);
    expect(legacyPartition.unresolvedMemberRoots.count).toBe(276);
    ...
    expect(partition.notSql).toHaveLength(2039);
