...
describe("repository-wide SQL execution partition", () => {
  ...
  it("measures the exact five-module and enforcement-neutral partition transition", () => {
    ...
    expect(legacyModules).toHaveLength(2397);
    expect(governedModules).toHaveLength(2392);
    ...
    expect(legacyPartition.notSql).toHaveLength(1989);
    ...
    expect(partition.notSql).toHaveLength(1984);
