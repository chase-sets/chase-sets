...
describe("repository-wide SQL execution partition", () => {
  ...
  it("measures the exact five-module and enforcement-neutral partition transition", () => {
    ...
    expect(legacyModules).toHaveLength(2388);
    expect(governedModules).toHaveLength(2383);
    ...
    expect(legacyPartition.notSql).toHaveLength(1984);
    ...
    expect(partition.notSql).toHaveLength(1979);
