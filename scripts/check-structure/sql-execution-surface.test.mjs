...
describe("repository-wide SQL execution partition", () => {
  ...
  it("measures the exact five-module and enforcement-neutral partition transition", () => {
    ...
    expect(legacyModules).toHaveLength(2323);
    expect(governedModules).toHaveLength(2318);
    ...
    expect(legacyPartition.notSql).toHaveLength(1935);
    ...
    expect(partition.notSql).toHaveLength(1930);
