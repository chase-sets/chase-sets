...
describe("repository-wide SQL execution partition", () => {
  ...
  it("measures the exact five-module and enforcement-neutral partition transition", () => {
    ...
    expect(legacyModules).toHaveLength(2440);
    expect(governedModules).toHaveLength(2435);
    ...
    expect(legacyPartition.sqlExecuting).toHaveLength(417);
    expect(legacyPartition.unprovableForm).toHaveLength(3);
    expect(legacyPartition.notSql).toHaveLength(2020);
    ...
    expect(partition.notSql).toHaveLength(2015);
