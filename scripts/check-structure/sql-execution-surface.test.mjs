...
describe("repository-wide SQL execution partition", () => {
  ...
  it("measures the exact five-module and enforcement-neutral partition transition", () => {
    ...
    expect(legacyModules).toHaveLength(2450);
    expect(governedModules).toHaveLength(2445);
    ...
    expect(legacyPartition.sqlExecuting).toHaveLength(421);
    expect(legacyPartition.unprovableForm).toHaveLength(3);
    expect(legacyPartition.notSql).toHaveLength(2026);
    ...
    expect(partition.notSql).toHaveLength(2021);
