...
describe("repository-wide SQL execution partition", () => {
  ...
  it("measures the exact five-module and enforcement-neutral partition transition", () => {
    ...
    expect(legacyModules).toHaveLength(2291);
    expect(governedModules).toHaveLength(2286);
    ...
    expect(legacyPartition.notSql).toHaveLength(1910);
    ...
    expect(partition.notSql).toHaveLength(1905);
    ...
    console.log(
      `SQL module inventory 2291 -> ${governedModules.length}; partition 378/3/1910 -> ` +
