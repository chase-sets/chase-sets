...
describe("repository-wide SQL execution partition", () => {
  ...
  it("measures the exact five-module and enforcement-neutral partition transition", () => {
    ...
    expect(legacyModules).toHaveLength(2460);
    expect(governedModules).toHaveLength(2455);
    ...
    expect(legacyPartition.notSql).toHaveLength(2032);
    ...
    expect(partition.notSql).toHaveLength(2027);
