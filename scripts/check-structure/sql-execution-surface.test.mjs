...
describe("repository-wide SQL execution partition", () => {
  ...
  it("measures the exact five-module and enforcement-neutral partition transition", () => {
    ...
    expect(legacyModules).toHaveLength(2297);
    expect(governedModules).toHaveLength(2292);
    ...
    expect(legacyPartition.sqlExecuting).toHaveLength(380);
    expect(legacyPartition.unprovableForm).toHaveLength(3);
    expect(legacyPartition.notSql).toHaveLength(1914);
    ...
    expect(partition.notSql).toHaveLength(1909);
