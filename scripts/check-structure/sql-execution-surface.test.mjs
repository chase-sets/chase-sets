...
describe("repository-wide SQL execution partition", () => {
  ...
  it("measures the exact five-module and enforcement-neutral partition transition", () => {
    ...
    expect(legacyModules).toHaveLength(2268);
    expect(governedModules).toHaveLength(2263);
    ...
    expect(legacyPartition.notSql).toHaveLength(1890);
    ...
    expect(partition.notSql).toHaveLength(1885);
