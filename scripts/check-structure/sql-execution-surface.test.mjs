...
describe("repository-wide SQL execution partition", () => {
  ...
  it("measures the exact five-module and enforcement-neutral partition transition", () => {
    ...
    expect(legacyModules).toHaveLength(2386);
    expect(governedModules).toHaveLength(2381);
    ...
    expect(legacyPartition.sqlExecuting).toHaveLength(401);
    expect(legacyPartition.unprovableForm).toHaveLength(3);
    expect(legacyPartition.notSql).toHaveLength(1982);
    ...
    expect(partition.notSql).toHaveLength(1977);
