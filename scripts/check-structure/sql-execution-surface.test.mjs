...
describe("repository-wide SQL execution partition", () => {
  ...
  it("measures the exact five-module and enforcement-neutral partition transition", () => {
    ...
    expect(legacyModules).toHaveLength(2462);
    expect(governedModules).toHaveLength(2457);
    ...
    expect(legacyPartition.sqlExecuting).toHaveLength(425);
    expect(legacyPartition.unprovableForm).toHaveLength(3);
    expect(legacyPartition.notSql).toHaveLength(2034);
    ...
    expect(partition.notSql).toHaveLength(2029);
