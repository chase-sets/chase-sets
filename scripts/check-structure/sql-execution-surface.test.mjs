...
describe("repository-wide SQL execution partition", () => {
  ...
  it("measures the exact five-module and enforcement-neutral partition transition", () => {
    ...
    expect(legacyModules).toHaveLength(2469);
    expect(governedModules).toHaveLength(2464);
    ...
    expect(legacyPartition.notSql).toHaveLength(2039);
    ...
    expect(partition.notSql).toHaveLength(2034);
