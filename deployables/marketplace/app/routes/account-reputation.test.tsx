...
import MarketplaceAccountReputationRoute, {
  loader,
} from "@chase-sets/reputation/routes/marketplace/account-reputation";
  ...
  it("loads the current account summary and public reviews", async () => {
    vi.stubGlobal(
      ...
      vi.fn((input: string | URL | Request) => {
        ...
        if (url.includes("/api/marketplace/accounts/acc_1/reputation")) {
