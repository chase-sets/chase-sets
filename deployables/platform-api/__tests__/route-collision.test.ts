...
describe("platform API route collision assembly", () => {
  it("boots all contexts with all 32 API entries using the exact closed keyed shape", () => {
    ...
    expect(rawEntries).toHaveLength(32);
    ...
    expect(report).toEqual({ scanned: 32, total: 32, routeCount: 832, duplicateGroups: [] });
    console.info(
