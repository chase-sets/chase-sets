...
export const bootstrapDbEnrollmentManifest = Object.freeze({
  ...
  "bootstrap-production-reconciliation.db.test.ts": Object.freeze({
    ...
    cases: Object.freeze([
      ...
      "completes the base Catalog authoring set after interruption following dimensions",
      "completes the base Catalog authoring set after interruption following components",
      "completes the base Catalog authoring set after interruption following blueprints",
