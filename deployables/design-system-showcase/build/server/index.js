...
import { ServerRouter, UNSAFE_withComponentProps, Outlet, Meta, Links, ScrollRestoration, Scripts, useLocation, useNavigate } from "react-router";
import { isbot } from "isbot";
import { renderToPipeableStream } from "react-dom/server";
import { createContext, useContext, useState, useSyncExternalStore, useMemo, forwardRef, useId, useRef, useCallback, Children } from "react";
import { MotionConfig, motion, LayoutGroup, AnimatePresence } from "motion/react";
...
const colorModeOrder = ["light", "dark", "system"];
...
function Container({
  ...
  return /* @__PURE__ */ jsx(
    "div",
    {
      ...
      children: /* @__PURE__ */ jsx("div", { className: cx("mx-auto w-full", layoutWidthClasses[width]), children })
    }
  );
}
function Stack({
...
function Inset({
  ...
  return /* @__PURE__ */ jsx(Box, { ...rest, padding, children });
}
function Center({
  children,
  inline = false,
...
function AspectRatio({
  ...
  return /* @__PURE__ */ jsx(AspectRatioPrimitive.Root, { ...rest, ratio, children });
}
...
function ScrollArea({
  ...
  return /* @__PURE__ */ jsxs(
    ScrollAreaPrimitive.Root,
    {
      ...
      children: [
        /* @__PURE__ */ jsx(ScrollAreaPrimitive.Viewport, { className: "h-full w-full", children }),
        /* @__PURE__ */ jsx(
...
function VisuallyHidden({
  ...
  return /* @__PURE__ */ jsx(VisuallyHiddenPrimitive.Root, { ...rest, children });
}
function SkipLink({
...
function NavRail({
  ...
  return /* @__PURE__ */ jsx(
    "nav",
    {
      ...
      children: /* @__PURE__ */ jsx(LayoutGroup, { id: groupId, children: items.map(
        (item) => renderNavigationItem(item, item.key === activeKey, "rail", groupId, onSelect)
      ) })
    }
  );
}
      ...
      children: [
        ...
        onRemove ? /* @__PURE__ */ jsx(
          "button",
          {
            ...
            children: /* @__PURE__ */ jsx(Icon, { name: "close", size: "sm", tone: toneToIconTone(tone) })
          }
        ) : null
      ]
    }
      ...
      TooltipPrimitive.Content,
      {
        ...
        children: /* @__PURE__ */ jsxs(
          motion.div,
          {
            ...
            children: [
              content,
              /* @__PURE__ */ jsx(TooltipPrimitive.Arrow, { className: "fill-foreground" })
            ]
          }
        )
      }
  ...
  return /* @__PURE__ */ jsxs(
    DropdownMenuPrimitive.Item,
    {
      ...
      children: [
        ...
        item.shortcut ? /* @__PURE__ */ jsx("span", { className: "ml-auto text-xs text-secondary", children: item.shortcut }) : null
      ]
    },
    item.key
  );
...
function ProgressBar({
  ...
  return /* @__PURE__ */ jsxs("div", { ...rest, className: "space-y-2", children: [
    ...
    /* @__PURE__ */ jsx("div", { className: "text-xs text-secondary", children: formatLabel(percentage) })
  ] });
}
function Skeleton({
  height = "md",
    ...
    AccordionPrimitive.Root,
    {
      ...
      children: items.map((item, index) => /* @__PURE__ */ jsxs(
        AccordionPrimitive.Item,
        {
          ...
          children: [
            /* @__PURE__ */ jsx(AccordionPrimitive.Header, { children: /* @__PURE__ */ jsxs(AccordionPrimitive.Trigger, { className: "focus-ring flex w-full items-center justify-between gap-3 px-4 py-3 text-left text-sm font-semibold text-foreground transition hover:bg-background [&[data-state=open]>span]:rotate-180", children: [
              /* @__PURE__ */ jsx("span", { className: "flex-1", children: item.trigger }),
              /* @__PURE__ */ jsx("span", { className: "inline-flex shrink-0 transition-transform duration-200", children: /* @__PURE__ */ jsx(Icon, { name: "chevronDown", size: "sm", tone: "secondary" }) })
            ] }) }),
            /* @__PURE__ */ jsx(AccordionPrimitive.Content, { forceMount: true, asChild: true, children: /* @__PURE__ */ jsx(AnimatedAccordionContent, { className: "overflow-hidden", children: /* @__PURE__ */ jsx("div", { className: "px-4 pb-4 text-sm text-secondary", children: item.content }) }) })
          ]
        },
        item.value
      ))
...
function DataTable({
  ...
  const cards = /* @__PURE__ */ jsx("div", { role: "list", className: "space-y-3 md:hidden", children: loading ? Array.from({ length: loadingRows }, (_, i) => /* @__PURE__ */ jsx("div", { className: "modern-surface rounded-tokenLg border border-muted p-4 shadow-tokenSm", children: /* @__PURE__ */ jsx("div", { className: "space-y-3", children: columns.map((column, colIndex) => /* @__PURE__ */ jsxs("div", { className: "flex items-start justify-between gap-4", children: [
    ...
    "div",
    {
      ...
      children: /* @__PURE__ */ jsx("div", { className: "space-y-3", children: columns.map((column) => /* @__PURE__ */ jsxs("div", { className: "flex items-start justify-between gap-4", children: [
...
function Stat({
  ...
  return /* @__PURE__ */ jsxs(
    "div",
    {
      ...
      className: "modern-surface rounded-tokenLg border border-muted p-4 shadow-tokenSm",
      children: [
        /* @__PURE__ */ jsx("div", { className: "text-xs font-semibold uppercase tracking-wide text-secondary", children: label }),
        /* @__PURE__ */ jsx("div", { className: "mt-2 font-heading text-3xl font-semibold text-foreground", children: value }),
        trend ? /* @__PURE__ */ jsx("div", { className: "mt-2 text-sm text-secondary", children: trend }) : null
      ]
    }
  );
}
...
function Timeline({
  ...
  return /* @__PURE__ */ jsx(
    "ol",
    {
      ...
      children: items.map((item, index) => /* @__PURE__ */ jsxs("li", { className: "flex gap-3", children: [
        /* @__PURE__ */ jsx("span", { className: "mt-1 inline-flex h-3 w-3 shrink-0 rounded-full bg-accent" }),
        /* @__PURE__ */ jsxs("div", { className: "space-y-1", children: [
          /* @__PURE__ */ jsx("div", { className: "text-sm font-semibold text-foreground", children: item.title }),
          item.description ? /* @__PURE__ */ jsx("div", { className: "text-sm text-secondary", children: item.description }) : null,
          item.timestamp ? /* @__PURE__ */ jsx("div", { className: "text-xs text-secondary", children: item.timestamp }) : null
        ] })
      ] }, index))
    }
  );
    ...
    "ul",
    {
      ...
      children: items.map((item, index) => /* @__PURE__ */ jsx(
        "li",
        {
          ...
          children: /* @__PURE__ */ jsxs("div", { className: "flex flex-wrap items-center justify-between gap-3", children: [
            /* @__PURE__ */ jsxs("div", { className: "space-y-1", children: [
              /* @__PURE__ */ jsx("div", { className: "text-sm font-semibold text-foreground", children: item.title }),
              item.description ? /* @__PURE__ */ jsx("div", { className: "text-sm text-secondary", children: item.description }) : null
            ] }),
...
function FilterDrawer({
  ...
  return /* @__PURE__ */ jsx(
    Drawer,
    {
      ...
      trigger,
      title,
      footer: /* @__PURE__ */ jsx(Button, { tone: "primary", block: true, children: applyLabel }),
...
function BulkActionBar({
  ...
  return /* @__PURE__ */ jsxs(
    motion.div,
    {
      ...
      children: [
        /* @__PURE__ */ jsx("div", { className: "text-sm font-semibold text-foreground", children: formatSelectedLabel(count) }),
        actions ? /* @__PURE__ */ jsx("div", { className: "flex flex-wrap gap-2", children: actions }) : null
      ]
    }
  );
...
function InlineMessage({
  ...
  return /* @__PURE__ */ jsxs(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsx(Icon, { name: icon, size: "sm", tone: tone === "default" ? "info" : tone }),
        /* @__PURE__ */ jsx("span", { children })
      ]
    }
  );
...
function Fieldset({
  ...
  return /* @__PURE__ */ jsxs("fieldset", { ...rest, className: "modern-surface space-y-4 rounded-tokenLg border border-muted p-4", children: [
    /* @__PURE__ */ jsxs("div", { className: "space-y-1", children: [
      /* @__PURE__ */ jsx("legend", { className: "text-sm font-semibold text-foreground", children: legend }),
...
function FormSection({
  ...
  return /* @__PURE__ */ jsxs("section", { ...rest, className: "modern-surface space-y-4 rounded-tokenLg border border-muted p-4 shadow-tokenSm", children: [
    /* @__PURE__ */ jsxs("div", { className: "space-y-1", children: [
      /* @__PURE__ */ jsx("h3", { className: "font-heading text-lg font-semibold text-foreground", children: title }),
      description ? /* @__PURE__ */ jsx("div", { className: "text-sm text-secondary", children: description }) : null
    ] }),
    children
  ] });
...
function NumberInput(props) {
  return /* @__PURE__ */ jsx(TextInput, { ...props, type: "number", inputMode: "numeric" });
}
  ...
  return /* @__PURE__ */ jsx(
    FieldChrome,
    {
      ...
      children: /* @__PURE__ */ jsxs("div", { className: "relative", children: [
        /* @__PURE__ */ jsx("span", { className: "pointer-events-none absolute inset-y-0 left-4 flex items-center text-secondary", children: currencySymbol }),
        /* @__PURE__ */ jsx(
          "input",
          {
            ...rest,
...
function Combobox({
  ...
  return /* @__PURE__ */ jsx(
    FieldChrome,
    {
      ...
      hideLabel,
      htmlFor: triggerId,
      children: /* @__PURE__ */ jsxs(PopoverPrimitive.Root, { open, onOpenChange: setOpen, children: [
        /* @__PURE__ */ jsxs(
          PopoverPrimitive.Trigger,
          {
            ...
            children: [
              ...
              /* @__PURE__ */ jsx(Icon, { name: "chevronDown", size: "sm", tone: "secondary" })
            ]
          }
        ),
        /* @__PURE__ */ jsx(PopoverPrimitive.Portal, { container: overlayNode ?? void 0, children: /* @__PURE__ */ jsx(
            ...
            children: /* @__PURE__ */ jsxs("div", { className: "space-y-3", children: [
              ...
              /* @__PURE__ */ jsx(
                "div",
                {
                  ...
                  children: filtered.length === 0 ? /* @__PURE__ */ jsx("div", { className: "rounded-tokenMd bg-background px-3 py-2 text-sm text-secondary", children: noMatchesLabel }) : filtered.map((item) => /* @__PURE__ */ jsxs(
                    "button",
                    {
                      type: "button",
                      role: "option",
                      ...
                      children: [
                        ...
                        item.value === value ? /* @__PURE__ */ jsx(Icon, { name: "check", size: "sm", tone: "accent" }) : null
                      ]
                    },
                    item.value
                  ))
...
function CheckboxGroup({
  ...
  return /* @__PURE__ */ jsx(
    FieldChrome,
    {
      ...
      required,
      hideLabel,
      children: /* @__PURE__ */ jsx("div", { className: "space-y-2", children: items.map((item) => {
        ...
        return /* @__PURE__ */ jsx(
          Checkbox,
          {
            ...
            onCheckedChange: (state) => {
              const next = state ? [...values, item.value] : values.filter((entry2) => entry2 !== item.value);
...
function Slider({
  ...
  return /* @__PURE__ */ jsx(
    FieldChrome,
    {
      ...
      required,
      hideLabel,
      children: /* @__PURE__ */ jsxs("div", { className: "modern-surface space-y-2 rounded-tokenMd border border-muted p-4", children: [
        /* @__PURE__ */ jsxs(
          SliderPrimitive.Root,
          {
            ...
            children: [
              /* @__PURE__ */ jsx(SliderPrimitive.Track, { className: "relative h-2 w-full rounded-full bg-muted", children: /* @__PURE__ */ jsx(SliderPrimitive.Range, { className: "absolute h-full rounded-full bg-accent" }) }),
        ...
        /* @__PURE__ */ jsxs("div", { className: "flex justify-between text-xs text-secondary", children: [
    ...
    FieldChrome,
    {
      ...
      children: /* @__PURE__ */ jsxs(
        "label",
        {
          ...
          children: [
            /* @__PURE__ */ jsx(Icon, { name: "package", size: "lg", tone: "accent" }),
            /* @__PURE__ */ jsxs("div", { className: "space-y-1", children: [
              /* @__PURE__ */ jsx("div", { className: "text-sm font-semibold text-foreground", children: dropLabel }),
              /* @__PURE__ */ jsx("div", { className: "text-xs text-secondary", children: browseLabel })
            ] }),
            /* @__PURE__ */ jsx(
              "input",
              {
            ...
            children: [
              ...
              /* @__PURE__ */ jsx(
                "button",
                {
                  ...
                  children: /* @__PURE__ */ jsx(Icon, { name: "close", size: "sm", tone: "secondary" })
                }
              )
            ]
          },
      ...
      children: /* @__PURE__ */ jsxs("div", { className: "relative", children: [
        ...
        /* @__PURE__ */ jsx(
          "button",
          {
            ...
            children: /* @__PURE__ */ jsx(Icon, { name: visible ? "eyeOff" : "eye", size: "sm", tone: "secondary" })
          }
        )
      ] })
    }
...
function ViewTransition({
  ...
  return /* @__PURE__ */ jsx(AnimatePresence, { initial: false, mode, children: /* @__PURE__ */ jsx(
    motion.div,
    {
      initial: definition.initial,
      animate: definition.animate,
...
function RecordPage({
  ...
  return /* @__PURE__ */ jsxs(Page, { width, children: [
    header,
    /* @__PURE__ */ jsx(
      SplitPane,
      {
...
function SearchResultsLayout({
  ...
  return /* @__PURE__ */ jsxs("div", { className: "grid gap-6 lg:grid-cols-[18rem_minmax(0,1fr)]", children: [
    /* @__PURE__ */ jsx("div", { className: "hidden lg:block", children: filters }),
    content
  ] });
}
function CheckoutLayout({
  ...
  return /* @__PURE__ */ jsxs("div", { className: "grid gap-6 lg:grid-cols-[minmax(0,1fr)_24rem]", children: [
    /* @__PURE__ */ jsx("div", { children }),
    /* @__PURE__ */ jsx("div", { className: "lg:sticky lg:top-24 lg:self-start", children: summary })
  ] });
}
function InspectorLayout({
  ...
  return /* @__PURE__ */ jsxs("div", { className: "grid gap-6 xl:grid-cols-[minmax(0,1fr)_22rem]", children: [
    /* @__PURE__ */ jsx("div", { children: main }),
    /* @__PURE__ */ jsx("div", { children: inspector })
  ] });
}
...
function ConditionBadge({
  ...
  return /* @__PURE__ */ jsx(Badge, { ...rest, tone, children: condition });
}
  ...
  return /* @__PURE__ */ jsxs(
    "div",
    {
      ...
      children: [
        ...
        verified ? /* @__PURE__ */ jsx(Badge, { tone: "success", children: "Verified" }) : null
      ]
    }
  );
}
function OrderSummary({
  ...
  return /* @__PURE__ */ jsxs(DetailPanel, { title, children: [
    /* @__PURE__ */ jsx(
      KeyValueList,
      {
    ...
    /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between border-t border-muted pt-4", children: [
      /* @__PURE__ */ jsx("span", { className: "text-sm font-semibold text-foreground", children: totalLabel }),
      /* @__PURE__ */ jsx("span", { className: "font-heading text-2xl font-semibold text-foreground", children: total })
    ] })
  ] });
}
function MetricStrip({
  ...
  return /* @__PURE__ */ jsx(StatGrid, { columns: { base: 1, sm: 2, xl: 4 }, children: items.map((item, index) => /* @__PURE__ */ jsx(
    Stat,
    {
      label: item.label,
      value: item.value,
...
function Wizard({
  ...
  return /* @__PURE__ */ jsxs("div", { className: "space-y-6", children: [
    /* @__PURE__ */ jsx(PageStepper, { items: stepperItems }),
    /* @__PURE__ */ jsx(AnimatePresence, { initial: false, mode: "wait", children: /* @__PURE__ */ jsx(
      motion.div,
      {
        initial: motionSettings.reducedMotion ? false : { opacity: 0, x: 18 },
        animate: motionSettings.reducedMotion ? void 0 : { opacity: 1, x: 0 },
        exit: motionSettings.reducedMotion ? void 0 : { opacity: 0, x: -12 },
        transition: motionSettings.reducedMotion ? void 0 : { duration: motionSettings.durations.base, ease: motionSettings.easing },
    ...
    /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between gap-3", children: [
      /* @__PURE__ */ jsx("div", { children: !isFirst ? /* @__PURE__ */ jsx(
        Button,
        {
          tone: "secondary",
      ...
      /* @__PURE__ */ jsx("div", { children: isLast ? /* @__PURE__ */ jsx(
        Button,
        {
          tone: "primary",
...
function Caption(props) {
  return /* @__PURE__ */ jsx(Text, { ...props, size: props.size ?? "xs", tone: props.tone ?? "secondary" });
}
function CodeText({
  children,
  ...rest
  ...
  return /* @__PURE__ */ jsxs(
    "a",
    {
      ...
      className: cx(
        ...
        tone === "accent" ? "text-accent hover:text-foreground hover:underline" : "text-secondary hover:text-foreground hover:underline"
      ),
      children: [
        /* @__PURE__ */ jsx("span", { children }),
        trailingIcon ? /* @__PURE__ */ jsx(Icon, { name: trailingIcon, size: "sm" }) : null
      ]
    }
  );
}
function List({
  ...
  return /* @__PURE__ */ jsx(
    Component,
    {
      ...rest,
      className: cx(
        "space-y-2 pl-5 text-sm leading-relaxed text-secondary",
...
function Quote({
  ...
  return /* @__PURE__ */ jsxs(
    "blockquote",
    {
      ...
      children: [
        /* @__PURE__ */ jsx(Text, { size: "md", weight: "medium", children }),
        cite ? /* @__PURE__ */ jsx(Text, { element: "div", size: "xs", tone: "secondary", children: cite }) : null
      ]
    }
  );
}
  ...
  if (src) {
    return /* @__PURE__ */ jsx(
      "img",
      {
        ...
        src,
        className: cx(
          "rounded-full border border-muted object-cover shadow-tokenSm",
          avatarSizeClasses[size]
        )
      }
    );
  }
  return /* @__PURE__ */ jsx("div", { "aria-label": alt ?? name, children: /* @__PURE__ */ jsx(
    "div",
    {
      className: cx(
...
function Thumbnail({
  ...
  return /* @__PURE__ */ jsx(Surface, { padding: 0, elevated: true, children: /* @__PURE__ */ jsx(AspectRatio, { ratio, children: src ? /* @__PURE__ */ jsx(
    "img",
    {
      ...rest,
      alt,
  ...
  ) : /* @__PURE__ */ jsx(Center, { children: /* @__PURE__ */ jsx("div", { className: "flex h-full w-full items-center justify-center bg-background", children: /* @__PURE__ */ jsx(Icon, { name: icon, size: "lg", tone: "secondary" }) }) }) }) });
}
function EmptyStateIllustration({
  title = "No results yet",
  ...rest
}) {
  return /* @__PURE__ */ jsx("div", { ...rest, className: "w-full", children: /* @__PURE__ */ jsx(AspectRatio, { ratio: 16 / 9, children: /* @__PURE__ */ jsx("div", { className: "flex h-full w-full items-center justify-center rounded-tokenLg border border-dashed border-muted bg-background", children: /* @__PURE__ */ jsxs("div", { className: "space-y-3 text-center", children: [
    /* @__PURE__ */ jsx(Center, { children: /* @__PURE__ */ jsx(Icon, { name: "spark", size: "lg", tone: "accent" }) }),
...
function ShowcaseThemeControl({
  ...
  return /* @__PURE__ */ jsxs(Inline, { gap: 2, align: "center", children: [
    /* @__PURE__ */ jsx(Text, { size: "sm", tone: "secondary", children: "Theme" }),
    /* @__PURE__ */ jsx(
      SegmentedControl,
      {
        value: colorMode,
    ...
    /* @__PURE__ */ jsx(Text, { size: "sm", tone: "secondary", children: "Motion" }),
    /* @__PURE__ */ jsx(
      SegmentedControl,
      {
        value: reducedMotion,
...
const layout = UNSAFE_withComponentProps(function ShowcaseLayoutRoute() {
  ...
  return /* @__PURE__ */ jsxs(ChaseRoot, {
    ...
    }), /* @__PURE__ */ jsx(Outlet, {}), /* @__PURE__ */ jsx(ToastRegion, {
      items: [{
        id: "demo-toast",
...
function MarketplaceView() {
  ...
  return /* @__PURE__ */ jsxs(
    MarketplaceShell,
    {
      brand: /* @__PURE__ */ jsx(SellerBadge, { name: "Chase Sets", verified: true }),
      topNavItems: marketplaceNav,
      bottomNavItems: marketplaceNav,
      activeKey: "browse",
      actions: /* @__PURE__ */ jsxs(Inline, { gap: 2, children: [
        /* @__PURE__ */ jsx(Tooltip, { content: "View your saved want lists", children: /* @__PURE__ */ jsx(IconButton, { label: "Saved wants", icon: "spark" }) }),
        /* @__PURE__ */ jsx(LinkButton, { href: "#sell", tone: "secondary", children: "Sell cards" })
      ] }),
      hero: /* @__PURE__ */ jsx(Surface, { elevated: true, children: /* @__PURE__ */ jsx(
        PageHeader,
        {
          eyebrow: "Marketplace",
          ...
          actions: /* @__PURE__ */ jsxs(Fragment, { children: [
            /* @__PURE__ */ jsx(Button, { children: "Start browsing" }),
            /* @__PURE__ */ jsx(Button, { tone: "secondary", children: "View saved wants" })
          ] })
        }
      ) }),
      sidebar: /* @__PURE__ */ jsxs(Stack, { gap: 4, children: [
        /* @__PURE__ */ jsxs(Surface, { children: [
          /* @__PURE__ */ jsx(Heading, { level: 4, children: "Quick Filters" }),
          /* @__PURE__ */ jsx(Text, { tone: "secondary", children: "Card type, rarity, price band, condition, and seller trust all fit into the same primitive stack." }),
          /* @__PURE__ */ jsxs(Inline, { gap: 2, children: [
            /* @__PURE__ */ jsx(Tag, { tone: "accent", onRemove: () => {
            }, children: "Modern" }),
            /* @__PURE__ */ jsx(Tag, { tone: "success", onRemove: () => {
            }, children: "Verified" }),
            /* @__PURE__ */ jsx(Badge, { tone: "info", children: "Ships fast" })
          ] })
        ] }),
        /* @__PURE__ */ jsxs(Surface, { children: [
          /* @__PURE__ */ jsx(Heading, { level: 5, children: "Top Sellers" }),
          /* @__PURE__ */ jsxs(Stack, { gap: 3, children: [
            /* @__PURE__ */ jsxs(Inline, { gap: 2, children: [
              /* @__PURE__ */ jsx(Avatar, { name: "North Side Cards", size: "sm" }),
              /* @__PURE__ */ jsxs(Stack, { gap: 0, children: [
                /* @__PURE__ */ jsx(Text, { size: "sm", weight: "semibold", children: "North Side Cards" }),
                /* @__PURE__ */ jsx(Caption, { children: "4.9 stars - 2,400 sales" })
              ] })
            ] }),
            /* @__PURE__ */ jsxs(Inline, { gap: 2, children: [
              /* @__PURE__ */ jsx(Avatar, { name: "Gem Mint TCG", size: "sm" }),
              /* @__PURE__ */ jsxs(Stack, { gap: 0, children: [
                /* @__PURE__ */ jsx(Text, { size: "sm", weight: "semibold", children: "Gem Mint TCG" }),
        ...
        /* @__PURE__ */ jsxs(Surface, { children: [
          /* @__PURE__ */ jsx(Heading, { level: 5, children: "Browse by Set" }),
          /* @__PURE__ */ jsx(
            Combobox,
            {
              label: "Set",
          ...
          PageSection,
          {
            ...
            children: [
              ...
              /* @__PURE__ */ jsxs(
                ...
                {
                  actions: /* @__PURE__ */ jsxs(Fragment, { children: [
                    /* @__PURE__ */ jsxs(FilterDrawer, { trigger: /* @__PURE__ */ jsx(Button, { tone: "secondary", children: "Filters" }), children: [
                      /* @__PURE__ */ jsx(
                        Select,
                        {
                          label: "Condition",
                    ...
                    /* @__PURE__ */ jsx(
                      Popover,
                      {
                        trigger: /* @__PURE__ */ jsx(Button, { tone: "ghost", children: "Sort" }),
                        title: "Sort listings",
                        children: /* @__PURE__ */ jsx(
                          RadioGroup,
                          {
              ...
              /* @__PURE__ */ jsx(
                SearchResultsLayout,
                {
                  summary: /* @__PURE__ */ jsxs(Inline, { gap: 3, align: "center", children: [
                    /* @__PURE__ */ jsx(Text, { tone: "secondary", children: "428 matching listings across 36 sellers with consolidated shipping." }),
                    /* @__PURE__ */ jsx(StatusPill, { tone: "success", children: "Live" })
                  ] }),
                  children: /* @__PURE__ */ jsx(Grid, { columns: { base: 1, sm: 2, lg: 3, xl: 4 }, gap: 3, children: inventoryRows.map((row) => /* @__PURE__ */ jsxs(Card, { children: [
                    /* @__PURE__ */ jsx(Thumbnail, { alt: row.card, ratio: 1 }),
                    /* @__PURE__ */ jsxs(Stack, { gap: 3, children: [
                      /* @__PURE__ */ jsxs(Inline, { gap: 2, children: [
                        /* @__PURE__ */ jsx(ConditionBadge, { condition: row.condition }),
                        /* @__PURE__ */ jsx(Badge, { tone: "success", children: "In stock" })
                      ] }),
                      /* @__PURE__ */ jsx(Heading, { level: 5, children: row.card }),
                      /* @__PURE__ */ jsxs(Inline, { gap: 2, children: [
                        /* @__PURE__ */ jsx(Avatar, { name: "North Side Cards", size: "sm" }),
                        /* @__PURE__ */ jsx(LinkText, { href: "#", children: "North Side Cards" })
                      ] }),
                      /* @__PURE__ */ jsxs(Inline, { gap: 3, children: [
                        /* @__PURE__ */ jsx(PriceDisplay, { amount: row.price }),
                        /* @__PURE__ */ jsxs(Text, { size: "sm", tone: "secondary", children: [
                          row.stock,
                          " available"
                        ] })
                      ] }),
                      /* @__PURE__ */ jsx(Tooltip, { content: "Add this card to your cart", children: /* @__PURE__ */ jsx(Button, { block: true, children: "Add to cart" }) })
                    ] })
                  ] }, row.sku)) })
                }
              ),
              /* @__PURE__ */ jsx(Pagination, { page: cartPage, totalPages: 48, onPageChange: setCartPage })
            ]
          }
        ),
        /* @__PURE__ */ jsxs(PageSection, { title: "Checkout Flow", children: [
          /* @__PURE__ */ jsx(
            PageStepper,
            {
              items: [
            ...
            CheckoutLayout,
            {
              ...
              children: /* @__PURE__ */ jsxs(
                FormSection,
                {
                  ...
                  children: [
                    /* @__PURE__ */ jsx(TextInput, { label: "Full name", defaultValue: "Todd S." }),
                    /* @__PURE__ */ jsx(TextInput, { label: "Address", placeholder: "123 Main St" }),
                    /* @__PURE__ */ jsxs(Inline, { gap: 3, children: [
                      /* @__PURE__ */ jsx(TextInput, { label: "City", placeholder: "Chicago" }),
                      /* @__PURE__ */ jsx(TextInput, { label: "ZIP", placeholder: "60601" })
                    ] }),
...
const marketplace = UNSAFE_withComponentProps(function MarketplaceShowcaseRoute() {
...
function AdminView() {
  ...
  return /* @__PURE__ */ jsx(
    AdminShell,
    {
      brand: /* @__PURE__ */ jsx(SellerBadge, { name: "Chase Sets Ops", verified: true }),
      navItems: adminNav,
      activeKey: "inventory",
      actions: /* @__PURE__ */ jsxs(Inline, { gap: 2, children: [
        /* @__PURE__ */ jsx(
          Menu,
          {
            trigger: /* @__PURE__ */ jsx(Button, { tone: "secondary", leadingIcon: "menu", children: "Actions" }),
            items: [
              {
                key: "export",
      ...
      children: /* @__PURE__ */ jsxs(Page, { children: [
        ...
        /* @__PURE__ */ jsx(
          Banner,
          {
            ...
            actions: /* @__PURE__ */ jsx(Button, { tone: "secondary", size: "sm", children: "View details" })
          }
        ),
        /* @__PURE__ */ jsx(
          MetricStrip,
        ...
        /* @__PURE__ */ jsx(PageSection, { title: "Fulfillment Progress", children: /* @__PURE__ */ jsxs(Grid, { columns: { base: 1, md: 2 }, gap: 4, children: [
          /* @__PURE__ */ jsx(Card, { children: /* @__PURE__ */ jsxs(Stack, { gap: 3, children: [
            /* @__PURE__ */ jsx(Text, { weight: "semibold", children: "Daily shipment quota" }),
            /* @__PURE__ */ jsx(ProgressBar, { value: sliderValue, tone: "accent" }),
            /* @__PURE__ */ jsxs(Caption, { children: [
              sliderValue,
              " of 100 orders shipped today"
            ] })
          ] }) }),
          /* @__PURE__ */ jsx(Card, { children: /* @__PURE__ */ jsxs(Stack, { gap: 3, children: [
            /* @__PURE__ */ jsx(Text, { weight: "semibold", children: "Processing pipeline" }),
            /* @__PURE__ */ jsxs(Inline, { gap: 2, children: [
              /* @__PURE__ */ jsx(LoadingSpinner, { size: "sm", label: "Syncing" }),
        ...
        /* @__PURE__ */ jsxs(PageSection, { title: "Inventory Table", children: [
          /* @__PURE__ */ jsx(
            DataTable,
            {
              rows: inventoryRows,
          ...
          /* @__PURE__ */ jsx(
            SelectionToolbar,
            {
              count: 3,
              actions: /* @__PURE__ */ jsxs(Fragment, { children: [
                /* @__PURE__ */ jsx(Button, { tone: "secondary", size: "sm", children: "Reprice" }),
                /* @__PURE__ */ jsx(Button, { tone: "secondary", size: "sm", children: "Export" })
              ] })
            }
          )
        ] }),
        /* @__PURE__ */ jsx(
          InspectorLayout,
          {
                  ...
                  /* @__PURE__ */ jsxs(
                    Fieldset,
                    {
                      ...
                      children: [
                        ...
                        /* @__PURE__ */ jsx(CurrencyInput, { label: "Unit price", defaultValue: "29.95" }),
                        /* @__PURE__ */ jsx(NumberInput, { label: "Quantity", defaultValue: "14" }),
                        /* @__PURE__ */ jsx(
                          Textarea,
                          {
                            label: "Seller notes",
                  ...
                  /* @__PURE__ */ jsxs(
                    Fieldset,
                    {
                      ...
                      children: [
                        ...
                        /* @__PURE__ */ jsx(InlineMessage, { tone: "success", icon: "check", children: "All required fields are complete. This listing is ready to publish." })
                      ]
                    }
                  )
                ]
            ...
            inspector: /* @__PURE__ */ jsxs(DetailPanel, { title: "Listing Preview", children: [
              /* @__PURE__ */ jsx(
                KeyValueList,
                {
                  items: [
              ...
              /* @__PURE__ */ jsxs(StatGrid, { children: [
                ...
                /* @__PURE__ */ jsx(Stat, { label: "Velocity", value: "2.1/day", trend: "Trending up" })
              ] }),
              /* @__PURE__ */ jsx(PageSection, { title: "Publish Health", children: /* @__PURE__ */ jsx(
                EmptyState,
                {
        ...
        /* @__PURE__ */ jsx(PageSection, { title: "Order Activity", children: /* @__PURE__ */ jsxs(Grid, { columns: { base: 1, lg: 2 }, gap: 4, children: [
          /* @__PURE__ */ jsx(Surface, { children: /* @__PURE__ */ jsx(
            Timeline,
            {
              items: [
                {
...
const admin = UNSAFE_withComponentProps(function AdminShowcaseRoute() {
...
function ColorModeToggleDemo() {
  ...
  return /* @__PURE__ */ jsx(ColorModeToggle, { value: mode, onValueChange: setMode });
}
function WizardDemo() {
  const [step, setStep] = useState("details");
  return /* @__PURE__ */ jsx(Surface, { children: /* @__PURE__ */ jsx(
    Wizard,
    {
      steps: [
        {
          key: "details",
          label: "Card Details",
          content: /* @__PURE__ */ jsxs(Stack, { gap: 3, children: [
            /* @__PURE__ */ jsx(TextInput, { label: "Card name", defaultValue: "Charizard ex" }),
            /* @__PURE__ */ jsx(
              Select,
              {
                label: "Set",
        ...
        },
        {
          ...
          content: /* @__PURE__ */ jsxs(Stack, { gap: 3, children: [
            ...
            /* @__PURE__ */ jsx(CurrencyInput, { label: "Price", defaultValue: "29.95" })
          ] })
        },
        {
          key: "review",
          label: "Review",
          content: /* @__PURE__ */ jsxs(Stack, { gap: 3, children: [
            /* @__PURE__ */ jsx(Text, { children: "Review your listing before publishing." }),
            /* @__PURE__ */ jsx(
              KeyValueList,
              {
                items: [
...
function MotionDemo() {
  ...
  return /* @__PURE__ */ jsx(Surface, { children: /* @__PURE__ */ jsxs(Stack, { gap: 4, children: [
    /* @__PURE__ */ jsx(
      SegmentedControl,
      {
        value: view,
    ...
    /* @__PURE__ */ jsx(ViewTransition, { transitionKey: view, children: view === "search" ? /* @__PURE__ */ jsx(Card, { children: /* @__PURE__ */ jsxs(Stack, { gap: 2, children: [
      /* @__PURE__ */ jsx(Text, { weight: "semibold", children: "Marketplace search view" }),
      /* @__PURE__ */ jsx(Text, { size: "sm", tone: "secondary", children: "Route-level transitions stay design-system led." })
    ] }) }) : /* @__PURE__ */ jsx(Card, { children: /* @__PURE__ */ jsxs(Stack, { gap: 2, children: [
      /* @__PURE__ */ jsx(Text, { weight: "semibold", children: "Item detail view" }),
      /* @__PURE__ */ jsx(Text, { size: "sm", tone: "secondary", children: "Panels can enter with shared timing and reduced-motion awareness." })
    ] }) }) }),
    /* @__PURE__ */ jsxs(Stagger, { children: [
      /* @__PURE__ */ jsx(Reveal, { preset: "fade", children: /* @__PURE__ */ jsx(Badge, { tone: "accent", children: "Fade" }) }),
      /* @__PURE__ */ jsx(Reveal, { preset: "lift", children: /* @__PURE__ */ jsx(Badge, { tone: "success", children: "Lift" }) }),
      /* @__PURE__ */ jsx(Reveal, { preset: "slideRight", children: /* @__PURE__ */ jsx(Badge, { tone: "info", children: "Slide Right" }) })
    ] })
  ] }) });
}
function ShowcaseIconCard({
  ...
  return /* @__PURE__ */ jsx(Surface, { children: /* @__PURE__ */ jsxs(Stack, { gap: 1, align: "center", children: [
    /* @__PURE__ */ jsx(Icon, { name, size: "md", tone: "accent" }),
...
function ComponentsView() {
  return /* @__PURE__ */ jsxs(Page, { children: [
    ...
    /* @__PURE__ */ jsx(PageSection, { title: "Icons", children: /* @__PURE__ */ jsx(Surface, { children: /* @__PURE__ */ jsx(Inline, { gap: 4, children: showcaseIconNames.map((name) => /* @__PURE__ */ jsx(ShowcaseIconCard, { name }, name)) }) }) }),
    /* @__PURE__ */ jsx(PageSection, { title: "Typography", children: /* @__PURE__ */ jsx(Surface, { children: /* @__PURE__ */ jsxs(Stack, { gap: 4, children: [
      /* @__PURE__ */ jsx(Heading, { level: 1, children: "Heading 1 - Display" }),
      /* @__PURE__ */ jsx(Heading, { level: 2, children: "Heading 2" }),
      /* @__PURE__ */ jsx(Heading, { level: 3, children: "Heading 3" }),
      /* @__PURE__ */ jsx(Heading, { level: 4, children: "Heading 4" }),
      /* @__PURE__ */ jsx(Heading, { level: 5, children: "Heading 5" }),
      /* @__PURE__ */ jsx(Heading, { level: 6, children: "Heading 6" }),
      /* @__PURE__ */ jsx(Divider, {}),
      /* @__PURE__ */ jsx(Text, { children: "Body text in the default size and weight." }),
      /* @__PURE__ */ jsx(Text, { size: "lg", weight: "semibold", children: "Large semibold text for emphasis." }),
      /* @__PURE__ */ jsx(Text, { size: "sm", tone: "secondary", children: "Small secondary text for supporting content." }),
      /* @__PURE__ */ jsx(Caption, { children: "Caption text for metadata and timestamps." }),
      /* @__PURE__ */ jsx(Label, { children: "Form label" }),
      /* @__PURE__ */ jsx(Label, { muted: true, children: "Muted label" }),
      /* @__PURE__ */ jsxs(Text, { children: [
        "Inline ",
        /* @__PURE__ */ jsx(CodeText, { children: "code snippets" }),
        " render in the mono font."
      ] }),
      /* @__PURE__ */ jsx(LinkText, { href: "#", children: "Accent link with default styling" }),
      /* @__PURE__ */ jsx(LinkText, { href: "#", tone: "subtle", trailingIcon: "chevronRight", children: "Subtle link with trailing icon" }),
      /* @__PURE__ */ jsx(Quote, { cite: "- Design system principles", children: "Every component should be composable, accessible, and theme-aware without requiring custom CSS." }),
      /* @__PURE__ */ jsx(
        List,
        {
          items: [
    ...
    /* @__PURE__ */ jsx(PageSection, { title: "Layout Primitives", children: /* @__PURE__ */ jsxs(Grid, { columns: { base: 1, md: 2 }, gap: 4, children: [
      /* @__PURE__ */ jsx(Card, { children: /* @__PURE__ */ jsxs(Stack, { gap: 3, children: [
        /* @__PURE__ */ jsx(Heading, { level: 5, children: "Box & Inset" }),
        /* @__PURE__ */ jsxs(Box, { padding: 4, gap: 2, children: [
          /* @__PURE__ */ jsx(Text, { size: "sm", tone: "secondary", children: "Box with padding=4 and gap=2" }),
          /* @__PURE__ */ jsx(Inset, { padding: 3, children: /* @__PURE__ */ jsx(Surface, { tone: "muted", children: /* @__PURE__ */ jsx(Text, { size: "sm", children: "Inset content inside a Box" }) }) })
        ] })
      ] }) }),
      /* @__PURE__ */ jsx(Card, { children: /* @__PURE__ */ jsxs(Stack, { gap: 3, children: [
        /* @__PURE__ */ jsx(Heading, { level: 5, children: "Center" }),
        /* @__PURE__ */ jsx(Surface, { tone: "muted", children: /* @__PURE__ */ jsx(Center, { children: /* @__PURE__ */ jsxs(Stack, { gap: 2, align: "center", children: [
          /* @__PURE__ */ jsx(Icon, { name: "spark", size: "lg", tone: "accent" }),
          /* @__PURE__ */ jsx(Text, { size: "sm", children: "Centered content" })
        ] }) }) })
      ] }) }),
      /* @__PURE__ */ jsx(Card, { children: /* @__PURE__ */ jsxs(Stack, { gap: 3, children: [
        /* @__PURE__ */ jsx(Heading, { level: 5, children: "Cluster" }),
        /* @__PURE__ */ jsxs(Cluster, { gap: 2, children: [
          /* @__PURE__ */ jsx(Badge, { children: "Tag A" }),
          /* @__PURE__ */ jsx(Badge, { tone: "accent", children: "Tag B" }),
          /* @__PURE__ */ jsx(Badge, { tone: "success", children: "Tag C" }),
          /* @__PURE__ */ jsx(Badge, { tone: "warning", children: "Tag D" }),
          /* @__PURE__ */ jsx(Badge, { tone: "info", children: "Tag E" })
        ] })
      ] }) }),
      /* @__PURE__ */ jsx(Card, { children: /* @__PURE__ */ jsxs(Stack, { gap: 3, children: [
        /* @__PURE__ */ jsx(Heading, { level: 5, children: "Spacer" }),
        /* @__PURE__ */ jsxs(Surface, { tone: "muted", children: [
          /* @__PURE__ */ jsx(Text, { size: "sm", children: "Above spacer" }),
          /* @__PURE__ */ jsx(Spacer, { size: 4 }),
          /* @__PURE__ */ jsx(Text, { size: "sm", children: "Below spacer (size=4)" })
        ] })
      ] }) }),
      /* @__PURE__ */ jsx(Card, { children: /* @__PURE__ */ jsxs(Stack, { gap: 3, children: [
        /* @__PURE__ */ jsx(Heading, { level: 5, children: "Container" }),
        /* @__PURE__ */ jsx(Container, { width: "narrow", paddingX: 4, children: /* @__PURE__ */ jsx(Surface, { tone: "muted", children: /* @__PURE__ */ jsx(Text, { size: "sm", children: "Narrow container (max-w-3xl)" }) }) })
      ] }) }),
      /* @__PURE__ */ jsx(Card, { children: /* @__PURE__ */ jsxs(Stack, { gap: 3, children: [
        /* @__PURE__ */ jsx(Heading, { level: 5, children: "AspectRatio" }),
        /* @__PURE__ */ jsx(AspectRatio, { ratio: 16 / 9, children: /* @__PURE__ */ jsx(Surface, { tone: "accent", padding: 0, children: /* @__PURE__ */ jsx(Center, { children: /* @__PURE__ */ jsx(Text, { tone: "inverse", weight: "semibold", children: "16:9" }) }) }) })
      ] }) }),
      /* @__PURE__ */ jsx(Card, { children: /* @__PURE__ */ jsxs(Stack, { gap: 3, children: [
        /* @__PURE__ */ jsx(Heading, { level: 5, children: "ScrollArea" }),
        /* @__PURE__ */ jsx(ScrollArea, { height: "sm", children: /* @__PURE__ */ jsx(Stack, { gap: 2, children: Array.from({ length: 12 }, (_, index) => /* @__PURE__ */ jsx(Inset, { padding: 3, children: /* @__PURE__ */ jsxs(Text, { size: "sm", children: [
          "Scrollable item ",
          index + 1
        ] }) }, index)) }) })
      ] }) }),
      /* @__PURE__ */ jsx(Card, { children: /* @__PURE__ */ jsxs(Stack, { gap: 3, children: [
        /* @__PURE__ */ jsx(Heading, { level: 5, children: "Divider" }),
        /* @__PURE__ */ jsx(Text, { size: "sm", children: "Content above" }),
        /* @__PURE__ */ jsx(Divider, {}),
        /* @__PURE__ */ jsx(Text, { size: "sm", children: "Content below" }),
        /* @__PURE__ */ jsxs(Inline, { gap: 3, align: "center", children: [
          /* @__PURE__ */ jsx(Text, { size: "sm", children: "Left" }),
          /* @__PURE__ */ jsx(Divider, { orientation: "vertical" }),
          /* @__PURE__ */ jsx(Text, { size: "sm", children: "Right" })
        ] })
      ] }) })
    ] }) }),
    /* @__PURE__ */ jsx(PageSection, { title: "Buttons & Navigation", children: /* @__PURE__ */ jsxs(Grid, { columns: { base: 1, md: 2 }, gap: 4, children: [
      /* @__PURE__ */ jsx(Card, { children: /* @__PURE__ */ jsxs(Stack, { gap: 3, children: [
        /* @__PURE__ */ jsx(Heading, { level: 5, children: "Button Variants" }),
        /* @__PURE__ */ jsxs(Inline, { gap: 2, children: [
          /* @__PURE__ */ jsx(Button, { children: "Primary" }),
          /* @__PURE__ */ jsx(Button, { tone: "secondary", children: "Secondary" }),
          /* @__PURE__ */ jsx(Button, { tone: "ghost", children: "Ghost" }),
          /* @__PURE__ */ jsx(Button, { tone: "danger", children: "Danger" })
        ] }),
        /* @__PURE__ */ jsxs(Inline, { gap: 2, children: [
          /* @__PURE__ */ jsx(Button, { size: "sm", children: "Small" }),
          /* @__PURE__ */ jsx(Button, { size: "md", children: "Medium" }),
          /* @__PURE__ */ jsx(Button, { size: "lg", children: "Large" })
        ] }),
        /* @__PURE__ */ jsxs(Inline, { gap: 2, children: [
          /* @__PURE__ */ jsx(IconButton, { label: "Search", icon: "search" }),
          /* @__PURE__ */ jsx(IconButton, { label: "Settings", icon: "settings", tone: "secondary" }),
          /* @__PURE__ */ jsx(IconButton, { label: "Close", icon: "close", tone: "ghost" })
        ] }),
        /* @__PURE__ */ jsx(LinkButton, { href: "#", leadingIcon: "cart", children: "Link as button" }),
        /* @__PURE__ */ jsxs(ButtonGroup, { children: [
          /* @__PURE__ */ jsx(Button, { tone: "secondary", size: "sm", children: "Secondary action" }),
          /* @__PURE__ */ jsx(Button, { size: "sm", children: "Primary action" })
        ] })
      ] }) }),
      /* @__PURE__ */ jsx(Card, { children: /* @__PURE__ */ jsxs(Stack, { gap: 3, children: [
        /* @__PURE__ */ jsx(Heading, { level: 5, children: "NavRail" }),
        /* @__PURE__ */ jsx(NavRail, { items: adminNav, activeKey: "dashboard" })
      ] }) })
    ] }) }),
    /* @__PURE__ */ jsx(PageSection, { title: "Motion", children: /* @__PURE__ */ jsxs(Grid, { columns: { base: 1, md: 2 }, gap: 4, children: [
      /* @__PURE__ */ jsx(MotionDemo, {}),
      /* @__PURE__ */ jsx(Card, { children: /* @__PURE__ */ jsxs(Stack, { gap: 3, children: [
        /* @__PURE__ */ jsx(Heading, { level: 5, children: "Motion policy" }),
        /* @__PURE__ */ jsx(Text, { size: "sm", tone: "secondary", children: "`ChaseRoot` owns reduced-motion behavior with system, full, and reduced modes." }),
        /* @__PURE__ */ jsx(Text, { size: "sm", tone: "secondary", children: "Core overlays, navigation, tabs, cards, toasts, and wizards now inherit the same timing model." })
      ] }) })
    ] }) }),
    /* @__PURE__ */ jsx(PageSection, { title: "Feedback & Overlays", children: /* @__PURE__ */ jsxs(Grid, { columns: { base: 1, md: 2 }, gap: 4, children: [
      /* @__PURE__ */ jsx(Card, { children: /* @__PURE__ */ jsxs(Stack, { gap: 3, children: [
        /* @__PURE__ */ jsx(Heading, { level: 5, children: "Badges & Pills" }),
        /* @__PURE__ */ jsxs(Inline, { gap: 2, children: [
          /* @__PURE__ */ jsx(Badge, { children: "Neutral" }),
          /* @__PURE__ */ jsx(Badge, { tone: "accent", children: "Accent" }),
          /* @__PURE__ */ jsx(Badge, { tone: "success", children: "Success" }),
          /* @__PURE__ */ jsx(Badge, { tone: "warning", children: "Warning" }),
          /* @__PURE__ */ jsx(Badge, { tone: "danger", children: "Danger" }),
          /* @__PURE__ */ jsx(Badge, { tone: "info", children: "Info" })
        ] }),
        /* @__PURE__ */ jsxs(Inline, { gap: 2, children: [
          /* @__PURE__ */ jsx(StatusPill, { tone: "success", children: "Active" }),
          /* @__PURE__ */ jsx(StatusPill, { tone: "warning", children: "Pending" }),
          /* @__PURE__ */ jsx(StatusPill, { tone: "danger", children: "Sold out" })
        ] }),
        /* @__PURE__ */ jsxs(Inline, { gap: 2, children: [
          /* @__PURE__ */ jsx(Tag, { onRemove: () => {
          }, children: "Removable" }),
          /* @__PURE__ */ jsx(Tag, { tone: "accent", onRemove: () => {
          }, children: "Accent tag" })
        ] })
      ...
      /* @__PURE__ */ jsx(Card, { children: /* @__PURE__ */ jsxs(Stack, { gap: 3, children: [
        /* @__PURE__ */ jsx(Heading, { level: 5, children: "Banners" }),
        /* @__PURE__ */ jsx(
          Banner,
          {
            tone: "success",
      ...
      /* @__PURE__ */ jsx(Card, { children: /* @__PURE__ */ jsxs(Stack, { gap: 3, children: [
        /* @__PURE__ */ jsx(Heading, { level: 5, children: "Loading States" }),
        /* @__PURE__ */ jsx(LoadingSpinner, { size: "sm", label: "Fetching listings..." }),
        /* @__PURE__ */ jsx(LoadingSpinner, { size: "md", label: "Processing order..." }),
        /* @__PURE__ */ jsx(ProgressBar, { value: 65, tone: "accent" }),
        /* @__PURE__ */ jsx(ProgressBar, { value: 30, tone: "warning" }),
        /* @__PURE__ */ jsx(Skeleton, { height: "sm" }),
        /* @__PURE__ */ jsx(Skeleton, { height: "md" }),
        /* @__PURE__ */ jsx(Skeleton, { height: "lg" })
      ] }) }),
      /* @__PURE__ */ jsx(Card, { children: /* @__PURE__ */ jsxs(Stack, { gap: 3, children: [
        /* @__PURE__ */ jsx(Heading, { level: 5, children: "Dialogs & Drawers" }),
        /* @__PURE__ */ jsxs(Inline, { gap: 2, children: [
          /* @__PURE__ */ jsx(
            Dialog,
            {
              trigger: /* @__PURE__ */ jsx(Button, { tone: "secondary", children: "Open dialog" }),
          ...
          /* @__PURE__ */ jsx(
            Drawer,
            {
              trigger: /* @__PURE__ */ jsx(Button, { tone: "secondary", children: "Open drawer" }),
              title: "Listing details",
              description: "Side panel for editing.",
              children: /* @__PURE__ */ jsxs(Stack, { gap: 3, children: [
                /* @__PURE__ */ jsx(TextInput, { label: "Title", defaultValue: "Charizard ex" }),
                /* @__PURE__ */ jsx(CurrencyInput, { label: "Price", defaultValue: "29.95" })
              ] })
            }
          )
      ...
      /* @__PURE__ */ jsx(Card, { children: /* @__PURE__ */ jsxs(Stack, { gap: 3, children: [
        /* @__PURE__ */ jsx(Heading, { level: 5, children: "Inline Messages & Helpers" }),
        /* @__PURE__ */ jsx(InlineMessage, { tone: "default", icon: "info", children: "Informational message for the user." }),
        /* @__PURE__ */ jsx(InlineMessage, { tone: "success", icon: "check", children: "Operation completed successfully." }),
        /* @__PURE__ */ jsx(InlineMessage, { tone: "danger", icon: "warning", children: "Something needs attention." }),
        /* @__PURE__ */ jsx(Field, { label: "Example field", children: /* @__PURE__ */ jsx(Text, { size: "sm", tone: "secondary", children: "Field wrapper for custom content." }) }),
        /* @__PURE__ */ jsx(HelperText, { children: "Default helper text below a field." }),
        /* @__PURE__ */ jsx(HelperText, { tone: "danger", children: "Error helper text." }),
        /* @__PURE__ */ jsx(HelperText, { tone: "success", children: "Success helper text." })
      ] }) }),
      /* @__PURE__ */ jsx(Card, { children: /* @__PURE__ */ jsxs(Stack, { gap: 3, children: [
        /* @__PURE__ */ jsx(Heading, { level: 5, children: "Empty States" }),
        /* @__PURE__ */ jsx(
          EmptyState,
          {
            ...
            icon: "search",
            actions: /* @__PURE__ */ jsx(Button, { tone: "secondary", size: "sm", children: "Clear filters" })
          }
        ),
        /* @__PURE__ */ jsx(EmptyStateIllustration, { title: "No chart data yet" })
      ] }) })
    ] }) }),
    /* @__PURE__ */ jsx(PageSection, { title: "Data Display", children: /* @__PURE__ */ jsxs(Grid, { columns: { base: 1, md: 2 }, gap: 4, children: [
      /* @__PURE__ */ jsx(Card, { children: /* @__PURE__ */ jsxs(Stack, { gap: 3, children: [
        /* @__PURE__ */ jsx(Heading, { level: 5, children: "Table (simple)" }),
        /* @__PURE__ */ jsx(
          Table,
          {
      ...
      /* @__PURE__ */ jsx(Card, { children: /* @__PURE__ */ jsxs(Stack, { gap: 3, children: [
        /* @__PURE__ */ jsx(Heading, { level: 5, children: "Avatars" }),
        /* @__PURE__ */ jsxs(Inline, { gap: 3, children: [
          /* @__PURE__ */ jsx(Avatar, { name: "Todd S.", size: "sm" }),
          /* @__PURE__ */ jsx(Avatar, { name: "North Side", size: "md" }),
          /* @__PURE__ */ jsx(Avatar, { name: "Gem Mint TCG", size: "lg" })
        ] }),
        /* @__PURE__ */ jsx(Heading, { level: 5, children: "Thumbnails" }),
        /* @__PURE__ */ jsxs(Grid, { columns: { base: 3 }, gap: 2, children: [
          /* @__PURE__ */ jsx(Thumbnail, { alt: "Card front", ratio: 3 / 4, icon: "spark" }),
          /* @__PURE__ */ jsx(Thumbnail, { alt: "Card back", ratio: 3 / 4, icon: "package" }),
          /* @__PURE__ */ jsx(Thumbnail, { alt: "Card detail", ratio: 3 / 4, icon: "search" })
        ] })
      ] }) })
    ] }) }),
    /* @__PURE__ */ jsx(PageSection, { title: "RecordPage Pattern", children: /* @__PURE__ */ jsx(
      RecordPage,
      {
        header: /* @__PURE__ */ jsx(
          PageHeader,
          {
            ...
            actions: /* @__PURE__ */ jsxs(Inline, { gap: 2, children: [
              /* @__PURE__ */ jsx(Button, { tone: "secondary", children: "Edit" }),
              /* @__PURE__ */ jsx(Button, { tone: "danger", children: "Cancel order" })
            ] })
          }
        ),
        summary: /* @__PURE__ */ jsxs(Stack, { gap: 4, children: [
          /* @__PURE__ */ jsx(
            KeyValueList,
            {
              items: [
        ...
        details: /* @__PURE__ */ jsx(Surface, { children: /* @__PURE__ */ jsxs(Stack, { gap: 4, children: [
          /* @__PURE__ */ jsx(Heading, { level: 5, children: "Order Details" }),
          /* @__PURE__ */ jsx(
            KeyValueList,
            {
              items: [
    ...
    /* @__PURE__ */ jsx(PageSection, { title: "New Components", children: /* @__PURE__ */ jsxs(Grid, { columns: { base: 1, md: 2 }, gap: 4, children: [
      /* @__PURE__ */ jsx(Card, { children: /* @__PURE__ */ jsxs(Stack, { gap: 3, children: [
        /* @__PURE__ */ jsx(Heading, { level: 5, children: "Rating" }),
        /* @__PURE__ */ jsxs(Inline, { gap: 4, align: "center", children: [
          /* @__PURE__ */ jsx(Rating, { value: 4, max: 5, size: "md", label: "Product rating" }),
          /* @__PURE__ */ jsx(Rating, { value: 3.5, max: 5, size: "sm", label: "Small rating" })
        ] }),
        /* @__PURE__ */ jsx(Text, { size: "sm", tone: "secondary", children: "Interactive rating:" }),
        /* @__PURE__ */ jsx(RatingDemo, {})
      ] }) }),
      /* @__PURE__ */ jsx(Card, { children: /* @__PURE__ */ jsxs(Stack, { gap: 3, children: [
        /* @__PURE__ */ jsx(Heading, { level: 5, children: "CopyButton" }),
        /* @__PURE__ */ jsxs(Inline, { gap: 2, children: [
          /* @__PURE__ */ jsx(
            CopyButton,
            {
      ...
      /* @__PURE__ */ jsx(Card, { children: /* @__PURE__ */ jsxs(Stack, { gap: 3, children: [
        /* @__PURE__ */ jsx(Heading, { level: 5, children: "Accordion" }),
        /* @__PURE__ */ jsx(
          Accordion,
          {
            type: "single",
            ...
            items: [
              {
                ...
                content: /* @__PURE__ */ jsx(Text, { size: "sm", children: "Charizard ex - 199/165, Surging Sparks. Illustration rare with textured holo." })
              },
              {
                value: "condition",
                trigger: "Condition Guide",
                content: /* @__PURE__ */ jsx(Text, { size: "sm", children: "Near Mint (NM): Minimal edge wear, no scratches on holo surface." })
              },
              {
                value: "shipping",
                trigger: "Shipping Policy",
                content: /* @__PURE__ */ jsx(Text, { size: "sm", children: "Free standard shipping on orders over $25. Cards ship in penny sleeve + toploader." })
              }
            ]
          }
        )
      ...
      /* @__PURE__ */ jsx(Card, { children: /* @__PURE__ */ jsxs(Stack, { gap: 3, children: [
        /* @__PURE__ */ jsx(Heading, { level: 5, children: "ImageGallery" }),
        /* @__PURE__ */ jsx(
          ImageGallery,
          {
            images: [
      ...
      /* @__PURE__ */ jsx(Card, { children: /* @__PURE__ */ jsxs(Stack, { gap: 3, children: [
        /* @__PURE__ */ jsx(Heading, { level: 5, children: "TagInput" }),
        /* @__PURE__ */ jsx(TagInputDemo, {})
      ] }) }),
      /* @__PURE__ */ jsx(Card, { children: /* @__PURE__ */ jsxs(Stack, { gap: 3, children: [
        /* @__PURE__ */ jsx(Heading, { level: 5, children: "PasswordInput" }),
        /* @__PURE__ */ jsx(PasswordInput, { label: "Password", placeholder: "Enter password" })
      ] }) }),
      /* @__PURE__ */ jsx(Card, { children: /* @__PURE__ */ jsxs(Stack, { gap: 3, children: [
        /* @__PURE__ */ jsx(Heading, { level: 5, children: "Card with Media Slot" }),
        /* @__PURE__ */ jsx(
          Card,
          {
            media: /* @__PURE__ */ jsx(AspectRatio, { ratio: 3 / 4, children: /* @__PURE__ */ jsx(Surface, { tone: "accent", padding: 0, children: /* @__PURE__ */ jsx(Center, { children: /* @__PURE__ */ jsx(Icon, { name: "image", size: "lg", tone: "inverse" }) }) }) }),
            interactive: true,
            children: /* @__PURE__ */ jsxs(Stack, { gap: 1, children: [
              /* @__PURE__ */ jsx(Text, { weight: "semibold", children: "Charizard ex - 199/165" }),
              /* @__PURE__ */ jsx(Text, { size: "sm", tone: "secondary", children: "Near Mint - Surging Sparks" }),
      ...
      /* @__PURE__ */ jsx(Card, { children: /* @__PURE__ */ jsxs(Stack, { gap: 3, children: [
        /* @__PURE__ */ jsx(Heading, { level: 5, children: "Enhanced Menu" }),
        /* @__PURE__ */ jsx(
          Menu,
          {
            trigger: /* @__PURE__ */ jsx(Button, { tone: "secondary", children: "Actions menu" }),
            groups: [
              {
                label: "Listing",
                items: [
      ...
      /* @__PURE__ */ jsx(Card, { children: /* @__PURE__ */ jsxs(Stack, { gap: 3, children: [
        /* @__PURE__ */ jsx(Heading, { level: 5, children: "Design System ColorModeToggle" }),
        /* @__PURE__ */ jsx(ColorModeToggleDemo, {})
      ] }) })
    ] }) }),
    /* @__PURE__ */ jsx(PageSection, { title: "Wizard Pattern", children: /* @__PURE__ */ jsx(WizardDemo, {}) }),
...
const components = UNSAFE_withComponentProps(function ComponentsShowcaseRoute() {
