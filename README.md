...
- `inventory` ([README](bounded-contexts/inventory/README.md), `@chase-sets/inventory`): owned nouns `inventory-item`, `inventory-hold`, `import-batch`, `recovered-item`, `storage-location`.
...
- `pricing` ([README](bounded-contexts/pricing/README.md), `@chase-sets/pricing`): owned nouns `market-price`, `market-price-snapshot`, `price-recommendation`, `price-signal`, `trades-tape`, `daily-product-rollup`, `platform-daily-rollup`, `gross-merchandise-value`, `market-state-snapshot`, `repricing-policy`, `repricing-policy-assignment`, `bulk-reprice-job`.
- `public-presence` ([README](bounded-contexts/public-presence/README.md), `@chase-sets/public-presence`): owned nouns `public-presence`, `waitlist-signup`, `promo-bar-message`, `help-article`, `help-category`, `developer-article`, `public-policy-artifact`.
...
- `deployables/platform-worker` (`@chase-sets/app-platform-worker`): package scripts `bootstrap`, `bootstrap:production`, `dev`, `dev:ci`, `start`, `start:production`, `test`, `test:fast`, `test:unit`, `test:watch`, `typecheck`.
