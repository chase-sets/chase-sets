...
- `inventory` ([README](bounded-contexts/inventory/README.md), `@chase-sets/inventory`): owned nouns `inventory-item`, `acquisition-occurrence`, `inventory-hold`, `import-batch`, `recovered-item`, `storage-location`, `external-channel-sale`.
