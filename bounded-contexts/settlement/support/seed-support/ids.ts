...
export const settlementReservedSeedIds = {
  ledgerEntries: {
    ...
    payoutFeeDebitCompleted: "led_seed_payout_fee_debit_completed" as LedgerEntryId,
    payoutDebitFailed: "led_seed_payout_debit_failed" as LedgerEntryId,
    payoutFeeDebitFailed: "led_seed_payout_fee_debit_failed" as LedgerEntryId,
    payoutReversalFailed: "led_seed_payout_reversal_failed" as LedgerEntryId,
    payoutFeeReversalFailed: "led_seed_payout_fee_reversal_failed" as LedgerEntryId,
  },
  payouts: {
