...
export const payoutUnavailableReasonLabels = {
  ...
  "payout-setup-refresh-required": moneyStatusLabel(
    "payout-setup-refresh-required",
  ),
  ...
  "payout-reconciliation-required": moneyStatusLabel(
    "payout-reconciliation-required",
  ),
  "platform-balance-insufficient": moneyStatusLabel(
  ...
  "amount-exceeds-available-balance": moneyStatusLabel(
    "amount-exceeds-available-balance",
  ),
} as const;

export type PayoutUnavailableReasonCode =
  keyof typeof payoutUnavailableReasonLabels;

export function payoutUnavailableReasonLabel(
  code: PayoutUnavailableReasonCode | string,
) {
