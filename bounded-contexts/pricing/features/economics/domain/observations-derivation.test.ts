...
describe("one-to-one capital-cycle observations", () => {
  it("splits quantity without reusing acquisition units and ignores unknown/cancelled/wrong-currency evidence", () => {
    const result = observeCapitalCycle({
      ...
      acquisitions: [
        { accountId: "synthetic-owner-account", inventoryItemId: "item-1", lotId: "lot-a", quantity: 2, occurrence: { kind: "occurred", occurredAt: "2026-01-01T00:00:00Z", source: "seller-supplied" } },
        { accountId: "synthetic-owner-account", inventoryItemId: "item-1", lotId: "lot-b", quantity: 2, occurrence: { kind: "occurred", occurredAt: "2026-01-02T00:00:00Z", source: "import-supplied" } },
        { accountId: "synthetic-owner-account", inventoryItemId: "item-1", lotId: "lot-unknown", quantity: 99, occurrence: { kind: "unknown" } },
      ],
      sales: [
        { accountId: "synthetic-owner-account", inventoryItemId: "item-1", saleId: "sale-a", quantity: 3, soldAt: "2026-01-11T00:00:00Z", currency: "usd", excluded: false },
        { accountId: "synthetic-owner-account", inventoryItemId: "item-1", saleId: "sale-b", quantity: 2, soldAt: "2026-01-12T00:00:00Z", currency: "usd", excluded: false },
        { accountId: "synthetic-owner-account", inventoryItemId: "item-1", saleId: "cancelled", quantity: 10, soldAt: "2026-01-13T00:00:00Z", currency: "usd", excluded: true },
        { accountId: "synthetic-owner-account", inventoryItemId: "item-1", saleId: "wrong-currency", quantity: 10, soldAt: "2026-01-13T00:00:00Z", currency: "eur", excluded: false },
      ],
    });
  ...
  it("matches turnaround across the account one-to-one with stable time/identity ordering", () => {
    const result = observeCapitalCycle({
      ...
      acquisitions: [
        { accountId: "synthetic-owner-account", inventoryItemId: "item-2", lotId: "lot-b", quantity: 2, occurrence: { kind: "occurred", occurredAt: "2026-01-06T00:00:00Z", source: "seller-supplied" } },
        { accountId: "synthetic-owner-account", inventoryItemId: "item-1", lotId: "lot-a", quantity: 2, occurrence: { kind: "occurred", occurredAt: "2026-01-05T00:00:00Z", source: "seller-supplied" } },
      ],
      sales: [
        { accountId: "synthetic-owner-account", inventoryItemId: "old-2", saleId: "sale-b", quantity: 1, soldAt: "2026-01-02T00:00:00Z", currency: "usd", excluded: false },
        { accountId: "synthetic-owner-account", inventoryItemId: "old-1", saleId: "sale-a", quantity: 2, soldAt: "2026-01-01T00:00:00Z", currency: "usd", excluded: false },
      ],
    });
  ...
  it("uses an inclusive effective boundary and reports duration exclusions even below the threshold", () => {
    const result = observeCapitalCycle({
      ...
      acquisitions: [
        { accountId: "synthetic-owner-account", inventoryItemId: "item-1", lotId: "lot-a", quantity: 1, occurrence: { kind: "occurred", occurredAt: "2026-01-01T00:00:00Z", source: "seller-supplied" } },
      ],
      sales: [
        { accountId: "synthetic-owner-account", inventoryItemId: "item-1", saleId: "sale-at-boundary", quantity: 1, soldAt: "2026-01-10T00:00:00Z", currency: "usd", excluded: false },
        { accountId: "synthetic-owner-account", inventoryItemId: "item-1", saleId: "sale-after-boundary", quantity: 1, soldAt: "2026-01-10T00:00:00.001Z", currency: "usd", excluded: false },
      ],
    });
...
describe("cost basis", () => {
  it("derives share over the same covered units and keeps partial coverage visible", () => {
    const result = deriveCostBasisFacts({
      ...
      lots: [
        { accountId: "synthetic-owner-account", inventoryItemId: "item-1", lotId: "lot-a", quantity: 2, acquisitionCostPerUnit: money("72.00"), observedAt: "2026-01-01T00:00:00Z", revision: "1" },
        { accountId: "synthetic-owner-account", inventoryItemId: "item-1", lotId: "lot-b", quantity: 2, acquisitionCostPerUnit: null, observedAt: "2026-01-02T00:00:00Z", revision: "2" },
      ],
    });
  ...
  it("defaults unavailable/foreign-currency cost instead of coercing it to zero", () => {
    const result = deriveCostBasisFacts({
      ...
      policy: policy(),
      lots: [{ accountId: "synthetic-owner-account", inventoryItemId: "item-1", lotId: "lot-a", quantity: 1, acquisitionCostPerUnit: money("72.00", "eur"), observedAt: "2026-01-01T00:00:00Z", revision: "1" }],
    });
    ...
    expect(result.discount.source).toEqual({ kind: "policy-owned", policyRevision: "sha256:synthetic-policy-revision" });
  });
});
