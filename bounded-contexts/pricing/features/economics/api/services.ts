...
export function createEconomicsServices(
  ...
  if (
    typeof deps?.commercialTermsResolver?.resolveListingTerms !== "function" ||
    typeof deps?.channelConnectionIdentityReader?.resolve !== "function"
  ) {
  ...
  return { resolve: resolver.resolve, overrides, providers };
}
