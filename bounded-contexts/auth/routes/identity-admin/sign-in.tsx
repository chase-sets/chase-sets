  ...
  return (
    <Container width="narrow">
      <SignInPage
        ...
        returnTo={identityAdminAuthHostConfig.defaultSuccessPath}
        ...
        socialLoginLinks={[
          {
            href: `/api/auth/social/google/start?journey=identity-admin&returnTo=${encodeURIComponent(
              identityAdminAuthHostConfig.defaultSuccessPath,
            )}`,
