...
export function postagePolicyRequestFromForm(formData: FormData): PostagePolicyCommandRequest {
  return {
    ...
    parcelRequiredShippingOptions: formStrings(
      formData,
      "parcelRequiredShippingOptions",
    ) as PostagePolicyCommandRequest["parcelRequiredShippingOptions"],
    letterRequiredPhysicalFlags: formStrings(
      formData,
      "letterRequiredPhysicalFlags",
    ) as PostagePolicyCommandRequest["letterRequiredPhysicalFlags"],
    parcelRequiredPhysicalFlags: formStrings(
      formData,
      "parcelRequiredPhysicalFlags",
    ) as PostagePolicyCommandRequest["parcelRequiredPhysicalFlags"],
    signatureRequiredShippingOptions: formStrings(
      formData,
      "signatureRequiredShippingOptions",
    ) as PostagePolicyCommandRequest["signatureRequiredShippingOptions"],
    signatureRequiredDeclaredValueAmount: formNullableNumber(formData, "signatureRequiredDeclaredValueAmount"),
    signatureRequiredPhysicalFlags: formStrings(
      formData,
...
export function postagePolicyPreviewRequestFromForm(formData: FormData): PostagePolicyPreviewRequest {
  return {
    ...
    shippingOption: String(
      formData.get("previewShippingOption") ?? "standard",
    ) as PostagePolicyPreviewRequest["shippingOption"],
    ...
    physicalFlags: formStrings(formData, "previewPhysicalFlags") as PostagePolicyPreviewRequest["physicalFlags"],
  };
}
