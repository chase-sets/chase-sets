...
- The Tax readiness record must encode the Tax posture as either `no_collection_required` or `provider_backed_quotes_required`, and the production environment's `TAX_PROVIDER_BACKED_QUOTES_REQUIRED` value must match that posture.
