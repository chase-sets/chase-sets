...
CREATE INDEX IF NOT EXISTS discovery_market_listings_item_idx
  ON discovery_market_listings (catalog_item_id);
CREATE INDEX IF NOT EXISTS discovery_market_listings_version_idx
  ON discovery_market_listings (catalog_version_key);
