...
Account History, Support, provider callback, or launch-decision facts. It must
...
| Tax, fee, and credit adjustment | Payments | payment-captured, order-committed, provider-callback, operator-recovery | tax-fee-credit-adjustment, payment-refund, settlement-adjustment | supported, pending, committed, failed, partial, deferred | Tax, marketplace fee, wallet credit, promo, gift-card, label-fee, payout, and settlement adjustments link to Payments/Settlement owner facts or a launch-decision deferral. |
| Seller pending handoff no fake reversal | Checkout | seller-confirmation-recorded, marketplace-handoff-recorded, launch-decision | support-review, no-side-effect | pending, deferred, no-side-effect | When seller activity shows only confirmation or pending handoff, reversal records customer-safe pending/deferred/no-side-effect status and must not create fake label, payout, settlement, notification, or account-history correction facts. |
...
- Release or staging evidence for payment authorization void, captured
