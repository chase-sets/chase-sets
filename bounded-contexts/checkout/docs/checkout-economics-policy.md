...
- Changed, expired, invalid, exhausted, stale, disabled, deferred, unsupported,
  ...
  visual target, support path, observability, launch owner, and #1116
  launch-register rows where launch-visible.
...
| Promo code launch decision | Checkout | cart-list-readiness, checkout-render, final-confirmation | deferred-with-launch-register | promo, payable-total | Customer-entered promo codes are not shown in the launch checkout unless a fresh-state capability is approved; unavailable promo entry is explicit before payment. |
| Gift card and store credit launch decision | Payments | cart-list-readiness, checkout-render, final-confirmation | deferred-with-launch-register | gift-card, payable-total, refund, reversal | Gift cards and store credit remain disabled or launch-registered until Payments owns issuance, redemption, refund, and reversal rules. |
...
| Reversal economics linkage | Payments | post-confirmation-reversal, operator-support | deferred-with-launch-register | refund, void, reversal, adjustment, tax, marketplace-checkout-fee, wallet-credit, gift-card, label-cost, seller-payout | Refund, void, reversal, adjustment, tax, fee, credit, gift-card, label, and payout economics link to #1165 recovery facts and remain deferred if owner rules are not launch-ready. |
...
- Current-main or staging evidence for buy payable total ordering, seller payout
...
- #1114 observability proving category-only telemetry, support-safe references,
  freshness status, launch-register decision, duplicate prevention, and no raw
