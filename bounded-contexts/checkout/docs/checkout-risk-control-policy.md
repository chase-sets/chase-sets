...
owned launch-decision state. Checkout does not expose raw risk signals
...
- Release or staging evidence for guest velocity, signed-in duplicate
...
- #1114 observability evidence proving risk telemetry reports categories,
  support-safe references, no-side-effect status, launch decisions, and
