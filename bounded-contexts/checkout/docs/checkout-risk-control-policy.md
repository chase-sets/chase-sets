...
owner-approved launch-register state. Checkout does not expose raw risk signals
or repair old checkout state to keep a customer moving.
...
- Seller readiness, listing abuse, payout risk, and label/payout provider holds
  stay in Sell List readiness or owner-approved hold states until the owning
  contexts clear them.
...
- Blocked, held, challenged, disabled, deferred, unsupported, and
  provider-unavailable states require #1116 launch-register coverage when they
...
| Launch-register risk states | Platform | cart-list-readiness, provider-or-wallet-return, final-confirmation, operator-support | buy-final-confirmation, sell-final-confirmation, payment-authorization-or-capture, payout-setup-or-eligibility, inventory-reservation | launch-register-required | launch-evidence | Blocked, held, challenged, disabled, deferred, unsupported, and provider-unavailable risk states have owner, copy, support path, observability, expiry/follow-up, and visual target evidence. |
...
- Current-main or staging evidence for guest velocity, signed-in duplicate
  ...
  submit idempotency.
- #1116 launch-register rows for blocked, held, challenged, disabled, deferred,
...
- #1114 observability evidence proving risk telemetry reports categories,
  support-safe references, no-side-effect status, launch-register decisions, and
  duplicate prevention without sensitive risk details.
- #1122 support evidence proving operators can distinguish customer error from
  risk hold without raw provider payloads, sensitive account data, or manual
  database edits.
