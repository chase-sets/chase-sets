...
export const checkoutObservabilityProfiles = [
  ...
  profile({
    ...
    ownerIssues: ["#1114", "#1115", "#1116", "#1117"],
  ...
  profile({
    ...
    ownerIssues: ["#1114", "#1115", "#1116", "#1121"],
    telemetryClass: "checkout-entry",
    scenarioStates: ["normal"],
    dimensions: ["readiness-contract", "readiness-snapshot-version", "source-revision", "performance-budget-id"],
    alertClass: "dashboard-only",
  ...
  profile({
    ...
    ownerIssues: ["#1114", "#1115", "#1116", "#1113"],
    telemetryClass: "checkout-entry",
    scenarioStates: ["normal", "deferred-capability"],
    dimensions: ["readiness-contract", "readiness-snapshot-version", "launch-register-decision", "provider-category"],
  ...
  profile({
    ...
    ownerIssues: ["#1114", "#1115", "#1116", "#1135"],
  ...
  profile({
    ...
    ownerIssues: ["#1114", "#1115", "#1116", "#1118"],
  ...
  profile({
    ...
    ownerIssues: ["#1114", "#1115", "#1116", "#1127"],
    telemetryClass: "recovery",
    scenarioStates: ["blocked"],
    dimensions: ["readiness-contract", "provider-category", "support-safe-reference", "launch-register-decision"],
    alertClass: "support-alert",
    releaseHealthRequired: true,
  ...
  profile({
    ...
    ownerIssues: ["#1114", "#1115", "#1116", "#1128"],
    telemetryClass: "recovery",
    scenarioStates: ["blocked"],
    dimensions: ["readiness-contract", "source-revision", "support-safe-reference", "launch-register-decision"],
    alertClass: "support-alert",
    releaseHealthRequired: true,
  ...
  profile({
    ...
    ownerIssues: ["#1114", "#1115", "#1116", "#1131", "#1134"],
    telemetryClass: "recovery",
  ...
  profile({
    ...
    ownerIssues: ["#1114", "#1115", "#1116", "#1164"],
    telemetryClass: "checkout-entry",
  ...
  profile({
    ...
    ownerIssues: ["#1114", "#1115", "#1116", "#1103"],
    telemetryClass: "launch-governance",
    scenarioStates: ["kill-switch"],
    dimensions: ["launch-register-decision", "support-safe-reference", "fresh-state-scan-result", "release-run-id"],
    alertClass: "launch-alert",
    releaseHealthRequired: true,
  ...
  profile({
    ...
    ownerIssues: ["#1114", "#1115", "#1116", "#1206"],
    telemetryClass: "checkout-entry",
  ...
  profile({
    ...
    ownerIssues: ["#1114", "#1115", "#1116", "#1123"],
    telemetryClass: "launch-governance",
  ...
  profile({
    ...
    dimensions: ["provider-category", "launch-register-decision", "support-safe-reference", "fresh-state-scan-result"],
    alertClass: "launch-alert",
    releaseHealthRequired: true,
  ...
  profile({
    ...
    dimensions: ["source-revision", "launch-register-decision", "support-safe-reference"],
    alertClass: "launch-alert",
    releaseHealthRequired: true,
  ...
  profile({
    ...
    ownerIssues: ["#1114", "#1115", "#1116", "#1129"],
    telemetryClass: "handoff",
    scenarioStates: ["notification", "support", "pending-downstream"],
    dimensions: ["downstream-status", "support-safe-reference", "launch-register-decision"],
    alertClass: "support-alert",
    releaseHealthRequired: true,
  ...
  profile({
    ...
    dimensions: ["downstream-status", "support-safe-reference", "performance-budget-id", "launch-register-decision"],
    alertClass: "support-alert",
    releaseHealthRequired: true,
    expectation:
  ...
  profile({
    ...
    ownerIssues: ["#1114", "#1115", "#1116", "#1130"],
    telemetryClass: "handoff",
  ...
  profile({
    ...
    ownerIssues: ["#1114", "#1115", "#1116", "#1165"],
    telemetryClass: "handoff",
  ...
  profile({
    ...
    ownerIssues: ["#1114", "#1115", "#1116", "#1132"],
    telemetryClass: "fresh-state-cleanup",
    scenarioStates: ["fresh-state-cleanup", "kill-switch"],
    dimensions: ["fresh-state-scan-result", "launch-register-decision", "release-run-id"],
    alertClass: "fresh-state-alert",
    releaseHealthRequired: true,
    expectation:
...
export function assertCheckoutObservabilityContractCoverage(): void {
  ...
  for (const row of checkoutLaunchEvidenceRows) {
    ...
    if (row.launchRegisterStatus === "required" && !profile.dimensions.includes("launch-register-decision")) {
      throw new Error(`Launch-register row '${row.state}' must emit launch-register-decision.`);
    }
