...
- **`support/` is composition-only.** Put shell wiring, authoring aggregation, and host-level helpers under `bounded-contexts/catalog/support/*-support/`; avoid feature domain/query/projection code there.
