...
// action result (when present). Preview-ready action data is a routable checkpoint,
// so the route replaces the URL with the same redirect href the server action uses.
