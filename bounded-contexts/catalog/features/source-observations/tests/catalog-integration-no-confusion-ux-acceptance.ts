...
function buildDefaultWorkflowEvidence(evidenceBase: string): readonly CatalogNoConfusionUxWorkflowEvidence[] {
  ...
  return [
    ...
    workflow(
      ...
      ["provider-profile.clone", "provider-profile.edit-section"],
    ...
    workflow(
      ...
      ["provider-profile.edit-section", "provider-profile.activate"],
    ...
    workflow(
      ...
      ["alias.accept", "alias.reject", "alias.defer", "alias.revoke"],
