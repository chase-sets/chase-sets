...
import { normalizeProductAssetSet, type CatalogImageProcessor } from "../seeding/product-asset-normalization";
import {
...
} from "../promotion/provider-external-reference-extractor";
