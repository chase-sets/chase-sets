...
export const catalogPrimaryWorkbenchCopyMessages = {
  "catalog.primary.providerScope.required": copy({
    label: "Provider context required",
  ...
  "catalog.primary.job.partial": copy({
    label: "Import completed with partial data",
  ...
  "catalog.primary.review.blocked": copy({
    label: "Review evidence degraded",
  ...
  "catalog.primary.promotion.previewRequired": copy({
    label: "Promotion preview required",
  ...
  "catalog.primary.promotion.stalePreview": copy({
    label: "Promotion preview is stale",
  ...
  "catalog.primary.promotion.securityBlocked": copy({
    label: "Security or privacy block",
  ...
  "catalog.primary.reapply.originalProfileMissing": copy({
    label: "Profile evidence missing",
  ...
  "catalog.primary.deploySkew.failClosed": copy({
    label: "Unsupported control-plane version",
...
export const catalogPrimaryWorkbenchProviderTransportCopy = {
  ...
  "pagination-failure": copy({
    label: "Provider pagination failed",
...
export const catalogPrimaryWorkbenchBlockerCopy = {
  ...
  "concurrent-job": copy({
    label: "Concurrent jobs detected",
  ...
  "fixture-validation-blocked": copy({
    label: "Fixture validation blocked",
  ...
  "provider-credential-missing": copy({
    label: "Provider credential missing",
  ...
  "provider-credential-invalid": copy({
    label: "Provider credential invalid",
  ...
  "provider-credential-expired": copy({
    label: "Provider credential expired",
  ...
  "source-projection-stale": copy({
    label: "Source Observation projection stale",
  ...
  "observation-not-found": copy({
    label: "Source Observation not found",
  ...
  "selection-empty": copy({
    label: "No observations selected",
  ...
  "no-promotion-eligible-observations": copy({
    label: "No promotable observations",
  ...
  "duplicate-conflict": copy({
    label: "Duplicate evidence conflict",
  ...
  "idempotency-replay": copy({
    label: "Idempotency replay in progress",
  ...
  "security-privacy-blocked": copy({
    label: "Security or privacy blocker",
  ...
  "deploy-skew-unsupported-version": copy({
    label: "Unsupported deployed version",
  ...
  "raw-json-retired": copy({
    label: "Payload escape hatch removed",
...
export const catalogPrimaryWorkbenchEmptyStateCopy = {
  "provider-scopes": copy({
    label: "No provider scopes are ready for import",
  ...
  "import-context": copy({
    label: "Import context is incomplete",
  ...
  "import-jobs": copy({
    label: "No durable import jobs for this context",
  ...
  "source-observations": copy({
    label: "No Source Observations in this context",
  ...
  "audit-evidence": copy({
    label: "No audit evidence for this context",
...
export const catalogPrimaryWorkbenchCompletionCopy = {
  ...
  "promotion-complete": copy({
    label: "Catalog promotion complete",
