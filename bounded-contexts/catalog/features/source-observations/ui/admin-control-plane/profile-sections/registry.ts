...
export const CATALOG_PROVIDER_PROFILE_SECTION_MODULES = [
  defineProfileSectionModule({
    section: "basics",
    label: t("catalog.features.sourceObservations.ui.integrationManagementPage.profile.section.basics"),
    area: "identity",
  ...
  defineProfileSectionModule({
    ...
    label: t("catalog.features.sourceObservations.ui.integrationManagementPage.provider.options"),
    area: "transport",
  ...
  defineProfileSectionModule({
    section: "connector",
    label: t("catalog.features.sourceObservations.ui.integrationManagementPage.connector"),
    area: "transport",
  ...
  defineProfileSectionModule({
    ...
    label: t("catalog.features.sourceObservations.ui.integrationManagementPage.profile.section.catalog.field.mapping"),
    area: "mapping",
    formStateKey: null,
  ...
  defineProfileSectionModule({
    ...
    label: t("catalog.features.sourceObservations.ui.integrationManagementPage.source.contract"),
    area: "governance",
  ...
  defineProfileSectionModule({
    ...
    label: t("catalog.features.sourceObservations.ui.integrationManagementPage.profile.section.source.observation"),
    area: "mapping",
    formStateKey: null,
  ...
  defineProfileSectionModule({
    ...
    label: t("catalog.features.sourceObservations.ui.integrationManagementPage.normalized.observation"),
    area: "mapping",
  ...
  defineProfileSectionModule({
    ...
    label: t("catalog.features.sourceObservations.ui.integrationManagementPage.external.references"),
    area: "mapping",
  ...
  defineProfileSectionModule({
    ...
    label: t("catalog.features.sourceObservations.ui.integrationManagementPage.profile.section.selected.options"),
    area: "mapping",
  ...
  defineProfileSectionModule({
    ...
    label: t("catalog.features.sourceObservations.ui.integrationManagementPage.reference.hierarchy"),
    area: "mapping",
  ...
  defineProfileSectionModule({
    ...
    label: t("catalog.features.sourceObservations.ui.integrationManagementPage.duplicate.prevention"),
    area: "mapping",
  ...
  defineProfileSectionModule({
    ...
    label: t("catalog.features.sourceObservations.ui.integrationManagementPage.promotion.plan"),
    area: "mapping",
  ...
  defineProfileSectionModule({
    ...
    label: t("catalog.features.sourceObservations.ui.integrationManagementPage.retirement.plan"),
    area: "governance",
