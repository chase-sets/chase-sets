 ...
 * consumed by the invitation (#5147), recording/CSAT (#5148), and dashboard
 * (#5153) leaves via the `./server` barrel.
 */
 ...
 * These are non-goals of the epic (#5144): NPS, CES, public reviews, experience
 ...
 * A submission is impossible until a value is deliberately chosen (#5146 AC5/AC6).
 */
