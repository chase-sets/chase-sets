...
| Creator Seeding | [Public Presence](../bounded-contexts/public-presence/GLOSSARY.md) | Weeks-3–4 outreach channel inviting mid-size creators to share a personal tracked (`?ref=`, `utm_source=creator`) link with their audience; zero new build (#4074). |
...
| Inline Apply | [ADR 0025](./adr/0025-write-path-inline-projection-apply.md) | Post-commit, best-effort application of a command's own events to an explicitly eligible same-context projection through the shared application ledger; it is request-bounded, never advances checkpoints, and always defers failures to the asynchronous runner. |
...
| Channel family | [Channels](../bounded-contexts/channels/GLOSSARY.md) owns Sales Channel connections and channel-sync language. [Notifications](../bounded-contexts/notifications/GLOSSARY.md) owns account notification delivery language, while platform architecture docs own wake/listener transport channels. | Qualify channel by surface or transport, such as Sales Channel, notification channel, wake channel, or listener channel. Do not let connection or transport channels become notification preferences. |
...
| Adjustment and correction family | [Settlement](../bounded-contexts/settlement/GLOSSARY.md) owns Wallet Adjustment (operator-requested-and-approved cash-equivalent correction), Rebate, and Chargeback Clawback as distinct ledger-entry kinds and posting paths; [ADR 0020](./adr/0020-wallet-adjustment-authority-and-balance-types.md) is the authority. | [Payments](../bounded-contexts/payments/GLOSSARY.md) owns Refund as the external processor-rail reversal of captured buyer funds — a Wallet Adjustment coded `refund-correction` only supplements its wallet-side consequence, never the external transaction itself. The future Marketplace Credit (#4891) is non-withdrawable and must not reuse the Wallet Adjustment command, lifecycle, or available-balance total. |
...
| m116-m121 store and inventory locations | [Inventory](../bounded-contexts/inventory/GLOSSARY.md) | Store; Storefront; Store Profile; Location Group; Stock Zone; Bin; Shelf; Aisle; Location Transfer; Transfer Batch; Transfer Line; Transfer Status; Replenishment Need; Inventory Count; Cycle Count; Count Variance; Stock Ledger; Channel Reservation; Channel Fulfillment Rule. Offline Sale, Channel Stock Allocation, and Channel Allocation Mode are implemented; see the local glossary. |
| m116-m121 account capabilities and store teams | [Identity](../bounded-contexts/identity/GLOSSARY.md) | Account Capability; Capability Grant; Capability Restriction; Capability Requirement; Capability Level; Account Standing; Capability Status; Capability Review; Store Team; Store Role; Store Invitation. |
| m116-m121 sales channels | [Channels](../bounded-contexts/channels/GLOSSARY.md) | Sales Channel; Channel Connection; BYO Channel; Channel Account; Channel Authorization; Channel Credential; Channel Webhook; Channel Health; Channel Mapping; Channel Listing Link; Channel Publication; Channel Publication Facts; Channel Composition Profile; Channel Publication Settings; Channel Publication Eligibility; Channel Listing Desired State; Channel Listing Reconciliation Run; Channel Provider Registry; Channel Provider Descriptor; Channel Sync; Channel Sync Run; Channel Sync Error; Channel Inventory Snapshot; Staged Import Batch; Snapshot Basis; Channel Export Surface; Mapping Bootstrap Candidate; Channel Outbound Operation; Outbound Operation Lane; Outbound Operation Attempt; Claimed Operation Reservation; Manual Sync Panel; Channel Inbound Coverage; Channel Inbound Clamp. |
...
| Wallet billing / capability-usage credit (#4891) | [Settlement](../bounded-contexts/settlement/GLOSSARY.md) | Marketplace Credit; Capability Usage Ledger Entry; Usage Statement Line. Non-withdrawable and usage-scoped; must not reuse the Wallet Adjustment command, lifecycle, or reason-code taxonomy ratified by [ADR 0020](./adr/0020-wallet-adjustment-authority-and-balance-types.md). |
| Card scanning (#4926) | Scanning (planned; no local glossary yet) — [ADR 0031](./adr/0031-card-identification-authority-and-provider-boundary.md) | Card Scan; Scan Session; Identification Attempt; Identification Candidate; Match Confidence Tier; Confirmed Match; Match Correction; Unidentified Scan. Provider identification output is advisory evidence; only an explicit seller-confirmed complete Catalog Product selection is authoritative. Product, Dimension, Option, `catalogItemId`, and `selectedOptions` stay Catalog-owned, and Import Batch stays Inventory-owned. Printing and Variant remain seller-facing descriptions of a Catalog Option selection, not Scanning-owned terms, and bare Correction is never registered — the term is Match Correction. |
