...
- [Tax Production Readiness](../bounded-contexts/tax/docs/production-tax-readiness.md): fail-closed Tax quote posture and production marketplace promotion evidence.
