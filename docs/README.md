...
- [Checkout Payment And Payout Affordance Policy](../bounded-contexts/checkout/docs/checkout-payment-payout-affordance-policy.md): Milestone #17 guest card form, saved payment, accelerated payment, payout setup, provider return, and sensitive-data guardrails.
