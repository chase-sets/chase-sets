...
- [Seed Pack Storage](./runbooks/seed-pack-storage.md): private versioned Observation Pack storage, scoped dev/CI key handoff, provider acceptance probes, rotation, and deletion-on-revocation.
