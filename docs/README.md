...
- [Projection Wake Relay](./architecture/projection-wake-relay.md): relay fan-out core that maps event-store wake hints into durable control-plane projection wake intents.
