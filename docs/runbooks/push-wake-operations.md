...
| `GET /api/platform/projections/wake-status` | Structural wake status for parity checks and automation (no payloads, no stream ids); use Grafana for trend/rate/percentile questions. | platform-api / admin-support-api, `projection-operations.view` |
