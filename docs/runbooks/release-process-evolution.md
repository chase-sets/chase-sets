...
| `projection-lag-poison-events` | `owning-bounded-context/platform-operations` | Projection freshness pending and work-signal error counters | Abort promotion and inspect Platform Operations projection health. |
