...
- Production: the production workflow validates approved launch evidence, approved Marketplace Checkout Fee evidence, approved Support operations evidence, approved Fulfillment postage evidence, approved transactional email evidence, approved Tax readiness evidence, live Stripe keys, EasyPost production mode, production Connect URLs, SES configuration, marketplace domain readiness, and marketplace smoke before tagging the release.
...
When set to `true`, Terraform deploys the production marketplace surface, full platform API, platform worker, and commerce bounded-context databases. The same switch also requires approved marketplace promotion evidence, approved Marketplace Checkout Fee evidence, approved Support operations evidence, approved Fulfillment postage evidence, approved transactional email evidence, live payment/shipping/email configuration, and approved Tax readiness evidence before Terraform can plan.
