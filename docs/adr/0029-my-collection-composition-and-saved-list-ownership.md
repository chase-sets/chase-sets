...
| --- | --- | --- | --- | --- | --- | --- | --- |
| `none (actor-presence + ownerAccountId scope)` | `GET /api/collections/saved-lists` | Actor account becomes `ownerAccountId` | Collections actor fence | route=yes / public contract=yes | n/a | HTTP mounted; UI state is not implied | Collections |
| `none (actor-presence + ownerAccountId scope)` | `GET /api/collections/saved-lists/:listId` | Actor account becomes `ownerAccountId` | Collections actor fence | route=yes / public contract=yes | n/a | HTTP mounted; UI state is not implied | Collections |
...
| `accounts.view` | `GET /api/collections/account/lists/recent` | Actor account is the query owner | Collections actor fence plus handler check | route=yes / public client=yes | n/a | HTTP mounted; Discovery's recent-list request uses its Discovery-owned endpoint | Collections |
