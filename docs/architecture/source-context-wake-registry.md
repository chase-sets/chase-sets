...
| `wave-3-platform-expansion` | `discovery`, `platform-operations`, `public-presence`, `reputation`, `settlement` | Expand lower-criticality or narrower fan-out contexts with owner approval. |
