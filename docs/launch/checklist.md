...
- [ ] No money, order, label, payout, or notification side effects start before explicit final confirmation (runtime guard baselines: PR #1453, PR #1454, PR #1455, PR #1456, PR #1458).
...
- [ ] Terms, privacy, and refund policy are linked from checkout; guest data handling is reviewed.
